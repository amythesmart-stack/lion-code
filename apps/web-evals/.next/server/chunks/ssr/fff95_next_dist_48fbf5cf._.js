module.exports = [
	...
	(a, b, c) => {
		...
		let f = "text/plain",
			...
			_ = "Your `getServerSideProps` function did not return an object. Did you forget to add a `return`?",
			aa = "The `unstable_revalidate` property is available for general use.\nPlease use `revalidate` instead.",
			ab =
			...
			af = { edge: "edge", experimentalEdge: "experimental-edge", nodejs: "nodejs" },
			ag = 12,
			ah = {
				shared: "shared",
...
//# sourceMappingURL=fff95_next_dist_48fbf5cf._.js.map

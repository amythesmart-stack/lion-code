module.exports = [
	...
	(a, b, c) => {
		...
		class h {
			...
			reset() {
				;(this.#a = 0), (this.#b = void 0)
			}
			write(a) {
				if (this.#a >= a.length || (this.#b && (this.#b(a) || this.#a >= a.length))) {
					this.#a -= a.length
					return
				}
				do {
					let b = a[this.#a]
					if (++this.#a === a.length) {
						this.#b = this.#c.bind(this, b)
						break
					}
					if (this.#d(b, a)) break
				} while (this.#a < a.length)
				this.#a -= a.length
			}
			#c(a, b) {
				return (this.#b = void 0), this.#d(a, b)
			}
			#d(a, b) {
				switch (a) {
					case c.RESP_TYPES.NULL:
						return this.onReply(this.#e()), !1
					case c.RESP_TYPES.BOOLEAN:
						return this.#f(this.onReply, this.#g(b))
					case c.RESP_TYPES.NUMBER:
						return this.#f(this.onReply, this.#h(this.getTypeMapping()[c.RESP_TYPES.NUMBER], b))
					case c.RESP_TYPES.BIG_NUMBER:
						return this.#f(this.onReply, this.#i(this.getTypeMapping()[c.RESP_TYPES.BIG_NUMBER], b))
					case c.RESP_TYPES.DOUBLE:
						return this.#f(this.onReply, this.#j(this.getTypeMapping()[c.RESP_TYPES.DOUBLE], b))
					case c.RESP_TYPES.SIMPLE_STRING:
						return this.#f(this.onReply, this.#k(this.getTypeMapping()[c.RESP_TYPES.SIMPLE_STRING], b))
					case c.RESP_TYPES.BLOB_STRING:
						return this.#f(this.onReply, this.#l(this.getTypeMapping()[c.RESP_TYPES.BLOB_STRING], b))
					case c.RESP_TYPES.VERBATIM_STRING:
						return this.#f(this.onReply, this.#m(this.getTypeMapping()[c.RESP_TYPES.VERBATIM_STRING], b))
					case c.RESP_TYPES.SIMPLE_ERROR:
						return this.#f(this.onErrorReply, this.#n(b))
					case c.RESP_TYPES.BLOB_ERROR:
						return this.#f(this.onErrorReply, this.#o(b))
					case c.RESP_TYPES.ARRAY:
						return this.#f(this.onReply, this.#p(this.getTypeMapping(), b))
					case c.RESP_TYPES.SET:
						return this.#f(this.onReply, this.#q(this.getTypeMapping(), b))
					case c.RESP_TYPES.MAP:
						return this.#f(this.onReply, this.#r(this.getTypeMapping(), b))
					case c.RESP_TYPES.PUSH:
						return this.#f(this.onPush, this.#p(c.PUSH_TYPE_MAPPING, b))
					default:
						throw Error(`Unknown RESP type ${a} "${String.fromCharCode(a)}"`)
				}
			}
			#f(a, b) {
				return "function" == typeof b ? ((this.#b = this.#s.bind(this, a, b)), !0) : (a(b), !1)
			}
			#s(a, b, c) {
				return (this.#b = void 0), this.#f(a, b(c))
			}
			#e() {
			...
			#h(a, b) {
				if (a === String) return this.#k(String, b)
				switch (b[this.#a]) {
					case g["+"]:
						return this.#t(!1, b)
					case g["-"]:
						return this.#t(!0, b)
					default:
						return this.#u(!1, this.#v.bind(this, 0), b)
				}
			}
			#t(a, b) {
				let c = this.#v.bind(this, 0)
				return ++this.#a === b.length ? this.#u.bind(this, a, c) : this.#u(a, c, b)
			}
			#u(a, b, c) {
				let d = b(c)
				return "function" == typeof d ? this.#u.bind(this, a, d) : a ? -d : d
			}
			#v(a, b) {
				let c = this.#a
				do {
					let d = b[c]
					if (d === g["\r"]) return (this.#a = c + 2), a
					a = 10 * a + d - g["0"]
				} while (++c < b.length)
				return (this.#a = c), this.#v.bind(this, a)
			}
			#i(a, b) {
				if (a === String) return this.#k(String, b)
				switch (b[this.#a]) {
					...
					case g["-"]:
						return this.#w(!0, b)
					default:
						return this.#x(!1, this.#y.bind(this, 0n), b)
				}
			}
			#w(a, b) {
				let c = this.#y.bind(this, 0n)
				return ++this.#a === b.length ? this.#x.bind(this, a, c) : this.#x(a, c, b)
			}
			#x(a, b, c) {
				let d = b(c)
				return "function" == typeof d ? this.#x.bind(this, a, d) : a ? -d : d
			}
			#y(a, b) {
				let c = this.#a
				do {
				...
				return (this.#a = c), this.#y.bind(this, a)
			}
			#j(a, b) {
				if (a === String) return this.#k(String, b)
				switch (b[this.#a]) {
			...
			#z(a, b) {
				return ++this.#a === b.length ? this.#A.bind(this, a, 0) : this.#A(a, 0, b)
			}
			#A(a, b, c) {
				return c[this.#a] === g.i ? ((this.#a += 5), a ? -1 / 0 : 1 / 0) : this.#B(a, b, c)
			}
			#B(a, b, c) {
				let d = this.#a
				do {
					...
					switch (e) {
						case g["."]:
							return (
								(this.#a = d + 1),
								this.#a < c.length ? this.#C(a, 0, b, c) : this.#C.bind(this, a, 0, b)
							)
						case g.E:
						case g.e:
							this.#a = d + 1
							let f = a ? -b : b
							return this.#a < c.length ? this.#D(f, c) : this.#D.bind(this, f)
						case g["\r"]:
							return (this.#a = d + 2), a ? -b : b
						default:
							b = 10 * b + e - g["0"]
					}
				} while (++d < c.length)
				return (this.#a = d), this.#B.bind(this, a, b)
			}
			static #E = [
				...
				do {
					...
					switch (h) {
						...
						case g.e:
							this.#a = f + 1
							let i = a ? -c : c
							return this.#a === e.length ? this.#D.bind(this, i) : this.#D(i, e)
						case g["\r"]:
							return (this.#a = f + 2), a ? -c : c
					}
					b < d.#E.length && (c += (h - g["0"]) * d.#E[b++])
				} while (++f < e.length)
				return (this.#a = f), this.#C.bind(this, a, b, c)
			}
			#D(a, b) {
				switch (b[this.#a]) {
					case g["+"]:
						return ++this.#a === b.length ? this.#F.bind(this, !1, a, 0) : this.#F(!1, a, 0, b)
					case g["-"]:
						return ++this.#a === b.length ? this.#F.bind(this, !0, a, 0) : this.#F(!0, a, 0, b)
				}
				return this.#F(!1, a, 0, b)
			}
			#F(a, b, c, d) {
				let e = this.#a
				do {
					let f = d[e]
					if (f === g["\r"]) return (this.#a = e + 2), b * 10 ** (a ? -c : c)
					c = 10 * c + f - g["0"]
				} while (++e < d.length)
				return (this.#a = e), this.#F.bind(this, a, b, c)
			}
			#G(a, b) {
				for (; a[b] !== g["\r"]; ) if (++b === a.length) return (this.#a = a.length), -1
				return (this.#a = b + 2), b
			}
			#k(a, b) {
				let c = this.#a,
					d = this.#G(b, c)
				if (-1 === d) return this.#H.bind(this, [b.subarray(c)], a)
			...
			#H(a, b, c) {
				let d = this.#a,
					e = this.#G(c, d)
				return -1 === e
					? (a.push(c.subarray(d)), this.#H.bind(this, a, b))
					: (a.push(c.subarray(d, e)), b === Buffer ? Buffer.concat(a) : a.join(""))
			}
			#l(a, b) {
				if (b[this.#a] === g["-"]) return (this.#a += 4), null
				let c = this.#v(0, b)
				return "function" == typeof c
					? this.#I.bind(this, c, a)
					: this.#a >= b.length
			...
			#K(a, b, c, d) {
				let e = this.#a + a
				if (e >= d.length) {
					let e = d.subarray(this.#a)
					return (this.#a = d.length), this.#L.bind(this, a - e.length, [e], b, c)
				}
				let f = d.subarray(this.#a, e)
				return (this.#a = e + b), c === Buffer ? f : f.toString()
			}
			#L(a, b, c, d, e) {
				let f = this.#a + a
				if (f >= e.length) {
					let f = e.subarray(this.#a)
					return b.push(f), (this.#a = e.length), this.#L.bind(this, a - f.length, b, c, d)
				}
				return b.push(e.subarray(this.#a, f)), (this.#a = f + c), d === Buffer ? Buffer.concat(b) : b.join("")
			}
			#J(a, b, c) {
				return this.#K(a, 2, b, c)
			}
			#m(a, b) {
				return this.#M(this.#v.bind(this, 0), a, b)
			}
			#M(a, b, c) {
				let d = a(c)
				return "function" == typeof d ? this.#M.bind(this, d, b) : this.#N(d, b, c)
			}
			#N(a, b, c) {
				let d = a - 4
				return b === e.VerbatimString
					? this.#O(d, c)
					: ((this.#a += 4), this.#a >= c.length ? this.#J.bind(this, d, b) : this.#J(d, b, c))
			}
			#O(a, b) {
				let c = this.#K.bind(this, 3, 1, String)
				return this.#a >= b.length ? this.#P.bind(this, a, c) : this.#P(a, c, b)
			}
			#P(a, b, c) {
				let d = b(c)
				return "function" == typeof d ? this.#P.bind(this, a, d) : this.#Q(a, d, c)
			}
			#Q(a, b, c) {
				return this.#R(b, this.#J.bind(this, a, String), c)
			}
			#R(a, b, c) {
				let d = b(c)
				return "function" == typeof d ? this.#R.bind(this, a, d) : new e.VerbatimString(a, d)
			}
			#n(a) {
				let b = this.#k(String, a)
				return "function" == typeof b ? this.#S.bind(this, b) : new f.SimpleError(b)
			}
			#S(a, b) {
				let c = a(b)
				return "function" == typeof c ? this.#S.bind(this, c) : new f.SimpleError(c)
			}
			#o(a) {
				let b = this.#l(String, a)
				return "function" == typeof b ? this.#T.bind(this, b) : new f.BlobError(b)
			}
			#T(a, b) {
				let c = a(b)
				return "function" == typeof c ? this.#T.bind(this, c) : new f.BlobError(c)
			}
			#U(a, b) {
				let c = b[this.#a]
				return ++this.#a === b.length ? this.#V.bind(this, c, a) : this.#V(c, a, b)
			}
			#V(a, b, d) {
				switch (a) {
					case c.RESP_TYPES.NULL:
					...
					case c.RESP_TYPES.BOOLEAN:
						return this.#g(d)
					case c.RESP_TYPES.NUMBER:
						return this.#h(b[c.RESP_TYPES.NUMBER], d)
					case c.RESP_TYPES.BIG_NUMBER:
						return this.#i(b[c.RESP_TYPES.BIG_NUMBER], d)
					case c.RESP_TYPES.DOUBLE:
						return this.#j(b[c.RESP_TYPES.DOUBLE], d)
					case c.RESP_TYPES.SIMPLE_STRING:
						return this.#k(b[c.RESP_TYPES.SIMPLE_STRING], d)
					case c.RESP_TYPES.BLOB_STRING:
						return this.#l(b[c.RESP_TYPES.BLOB_STRING], d)
					case c.RESP_TYPES.VERBATIM_STRING:
						return this.#m(b[c.RESP_TYPES.VERBATIM_STRING], d)
					case c.RESP_TYPES.SIMPLE_ERROR:
						return this.#n(d)
					case c.RESP_TYPES.BLOB_ERROR:
						return this.#o(d)
			...
			#p(a, b) {
				return b[this.#a] === g["-"] ? ((this.#a += 4), null) : this.#W(this.#v(0, b), a, b)
			}
			#W(a, b, c) {
				return "function" == typeof a ? this.#X.bind(this, a, b) : this.#Y(Array(a), 0, b, c)
			}
			#X(a, b, c) {
				return this.#W(a(c), b, c)
			}
			#Y(a, b, c, d) {
				for (let e = b; e < a.length; e++) {
					if (this.#a >= d.length) return this.#Y.bind(this, a, e, c)
					let b = this.#U(c, d)
					if ("function" == typeof b) return this.#Z.bind(this, a, e, b, c)
					a[e] = b
				}
				return a
			}
			#Z(a, b, c, d, e) {
				let f = c(e)
				return "function" == typeof f ? this.#Z.bind(this, a, b, f, d) : ((a[b++] = f), this.#Y(a, b, d, e))
			}
			#q(a, b) {
				let c = this.#v(0, b)
				return "function" == typeof c ? this.#$.bind(this, c, a) : this.#_(c, a, b)
			}
			#$(a, b, c) {
				let d = a(c)
				return "function" == typeof d ? this.#$.bind(this, d, b) : this.#_(d, b, c)
			}
			#_(a, b, d) {
				return b[c.RESP_TYPES.SET] === Set ? this.#aa(new Set(), a, b, d) : this.#Y(Array(a), 0, b, d)
			}
			#aa(a, b, c, d) {
				for (; b > 0; ) {
					if (this.#a >= d.length) return this.#aa.bind(this, a, b, c)
					let e = this.#U(c, d)
					if ("function" == typeof e) return this.#ab.bind(this, a, b, e, c)
					a.add(e), --b
				}
				return a
			}
			#ab(a, b, c, d, e) {
				let f = c(e)
				return "function" == typeof f ? this.#ab.bind(this, a, b, f, d) : (a.add(f), this.#aa(a, b - 1, d, e))
			}
			#r(a, b) {
				let c = this.#v(0, b)
				return "function" == typeof c ? this.#ac.bind(this, c, a) : this.#ad(c, a, b)
			}
			#ac(a, b, c) {
				let d = a(c)
				return "function" == typeof d ? this.#ac.bind(this, d, b) : this.#ad(d, b, c)
			}
			#ad(a, b, d) {
				switch (b[c.RESP_TYPES.MAP]) {
					case Map:
						return this.#ae(new Map(), a, b, d)
					case Array:
						return this.#Y(Array(2 * a), 0, b, d)
					default:
						return this.#af(Object.create(null), a, b, d)
				}
			}
			#ae(a, b, c, d) {
				for (; b > 0; ) {
					if (this.#a >= d.length) return this.#ae.bind(this, a, b, c)
					let e = this.#ag(c, d)
					if ("function" == typeof e) return this.#ah.bind(this, a, b, e, c)
					if (this.#a >= d.length) return this.#ai.bind(this, a, b, e, this.#U.bind(this, c), c)
					let f = this.#U(c, d)
			...
			#ag(a, b) {
				let c = b[this.#a]
				return ++this.#a === b.length ? this.#aj.bind(this, c, a) : this.#aj(c, a, b)
			}
			#aj(a, b, d) {
				switch (a) {
					case c.RESP_TYPES.SIMPLE_STRING:
						return this.#k(String, d)
					case c.RESP_TYPES.BLOB_STRING:
			...
			#ah(a, b, c, d, e) {
				let f = c(e)
				if ("function" == typeof f) return this.#ah.bind(this, a, b, f, d)
				if (this.#a >= e.length) return this.#ai.bind(this, a, b, f, this.#U.bind(this, d), d)
				let g = this.#U(d, e)
				return "function" == typeof g
					? this.#ai.bind(this, a, b, f, g, d)
					: (a.set(f, g), this.#ae(a, b - 1, d, e))
			}
			#ai(a, b, c, d, e, f) {
				let g = d(f)
				return "function" == typeof g
					? this.#ai.bind(this, a, b, c, g, e)
					: (a.set(c, g), this.#ae(a, b - 1, e, f))
			}
			#af(a, b, c, d) {
				for (; b > 0; ) {
					if (this.#a >= d.length) return this.#af.bind(this, a, b, c)
					let e = this.#ag(c, d)
					if ("function" == typeof e) return this.#ak.bind(this, a, b, e, c)
					if (this.#a >= d.length) return this.#al.bind(this, a, b, e, this.#U.bind(this, c), c)
					let f = this.#U(c, d)
			...
			#ak(a, b, c, d, e) {
				let f = c(e)
				if ("function" == typeof f) return this.#ak.bind(this, a, b, f, d)
				if (this.#a >= e.length) return this.#al.bind(this, a, b, f, this.#U.bind(this, d), d)
				let g = this.#U(d, e)
				return "function" == typeof g
					? this.#al.bind(this, a, b, f, g, d)
					: ((a[f] = g), this.#af(a, b - 1, d, e))
			}
			#al(a, b, c, d, e, f) {
				let g = d(f)
				return "function" == typeof g
					? this.#al.bind(this, a, b, c, g, e)
					: ((a[c] = g), this.#af(a, b - 1, e, f))
			}
		}
		;(c.Decoder = h), (d = h)
	},
	...
	(a, b, c) => {
		...
		Object.defineProperty(c, "__esModule", { value: !0 }),
			...
			(c.BasicCommandParser = class {
				...
				get cacheKey() {
					let a = Array(2 * this.#am.length)
					for (let b = 0; b < this.#am.length; b++)
						(a[b] = this.#am[b].length), (a[b + this.#am.length] = this.#am[b])
					return a.join("_")
				}
				push(...a) {
					this.#am.push(...a)
				...
				pushVariadicWithLength(a) {
					Array.isArray(a) ? this.#am.push(a.length.toString()) : this.#am.push("1"), this.pushVariadic(a)
				}
				...
				pushKey(a) {
					this.#an.push(a), this.#am.push(a)
				}
				pushKeysLength(a) {
					Array.isArray(a) ? this.#am.push(a.length.toString()) : this.#am.push("1"), this.pushKeys(a)
				}
				pushKeys(a) {
					Array.isArray(a) ? (this.#an.push(...a), this.#am.push(...a)) : (this.#an.push(a), this.#am.push(a))
				}
			})
	},
	24886,
	...
	(a, b, c) => {
		...
		class j extends e.EventEmitter {
			...
			constructor(a, b) {
				super(),
					(this.#ao = a),
					(this.#ap = b?.connectTimeout ?? 5e3),
					(this.#aq = this.#ay(b)),
					(this.#ar = this.#az(b)),
					(this.#as = b?.socketTimeout)
			}
			#ay(a) {
			...
			#aA(a, b) {
				let c = this.#aq(a, b)
				return !1 === c
					? ((this.#au = !1), this.emit("error", b), b)
					: c instanceof Error
						? ((this.#au = !1), this.emit("error", b), new h.ReconnectStrategyError(c, b))
						: c
			}
			async connect() {
				if (this.#au) throw Error("Socket already opened")
				return (this.#au = !0), this.#aB()
			}
			async #aB() {
				let a = 0
				do
					try {
						;(this.#at = await this.#aC()), this.emit("connect")
						try {
							await this.#ao()
						} catch (a) {
							throw (this.#at.destroy(), (this.#at = void 0), a)
						}
						;(this.#av = !0), this.#ax++, this.emit("ready")
					} catch (c) {
						let b = this.#aA(a++, c)
			...
			async #aC() {
				...
				return (
					void 0 !== this.#ap &&
						...
						b.once("timeout", a),
						b.setTimeout(this.#ap)),
					this.#aw && b.unref(),
					await (0, e.once)(b, this.#ar.event),
					a && b.removeListener("timeout", a),
					this.#as &&
						(b.once("timeout", () => {
							b.destroy(new h.SocketTimeoutError(this.#as))
						}),
						b.setTimeout(this.#as)),
					b
						.once("error", (a) => this.#aD(a))
						.once("close", (a) => {
							!a && this.#au && this.#at === b && this.#aD(new h.SocketClosedUnexpectedlyError())
						})
			...
			#aD(a) {
				...
				;(this.#av = !1),
					...
					b &&
						this.#au &&
						"number" == typeof this.#aA(0, a) &&
						(this.emit("reconnecting"), this.#aB().catch(() => {}))
			}
			write(a) {
				if (this.#at) {
					for (let b of (this.#at.cork(), a)) {
						for (let a of b) this.#at.write(a)
						if (this.#at.writableNeedDrain) break
					}
					this.#at.uncork()
				}
			}
			async quit(a) {
				if (!this.#au) throw new h.ClientClosedError()
				this.#au = !1
				let b = await a()
			...
			destroy() {
				if (!this.#au) throw new h.ClientClosedError()
				;(this.#au = !1), this.destroySocket()
			}
			destroySocket() {
				;(this.#av = !1), this.#at && (this.#at.destroy(), (this.#at = void 0)), this.emit("end")
			}
			ref() {
				;(this.#aw = !1), this.#at?.ref()
			}
			unref() {
				;(this.#aw = !0), this.#at?.unref()
			}
	...
	(a, b, c) => {
		...
		class d {
			...
			push(a) {
				return (++this.#aE, void 0 === this.#aG)
					? (this.#aG = this.#aF = { previous: this.#aF, next: void 0, value: a })
					: (this.#aG = this.#aG.next = { previous: this.#aG, next: void 0, value: a })
			}
			unshift(a) {
				return (++this.#aE, void 0 === this.#aF)
					? (this.#aF = this.#aG = { previous: void 0, next: void 0, value: a })
					: (this.#aF = this.#aF.previous = { previous: void 0, next: this.#aF, value: a })
			}
			add(a, b = !1) {
				return b ? this.unshift(a) : this.push(a)
			}
			shift() {
				if (void 0 === this.#aF) return
				--this.#aE
				let a = this.#aF
				return (
					a.next
						? ((a.next.previous = a.previous), (this.#aF = a.next), (a.next = void 0))
						: (this.#aF = this.#aG = void 0),
					a.value
				)
			}
			remove(a) {
				--this.#aE,
					this.#aG === a && (this.#aG = a.previous),
					this.#aF === a ? (this.#aF = a.next) : ((a.previous.next = a.next), (a.previous = void 0)),
					(a.next = void 0)
			}
			reset() {
				;(this.#aE = 0), (this.#aF = this.#aG = void 0)
			}
			*[Symbol.iterator]() {
				let a = this.#aF
		...
		class e {
			...
			push(a) {
				...
				return void 0 === this.#aF ? (this.#aF = this.#aG = b) : (this.#aG.next = this.#aG = b)
			}
			remove(a, b) {
			...
			shift() {
				if (void 0 === this.#aF) return
				let a = this.#aF
				return 0 == --this.#aE ? (this.#aF = this.#aG = void 0) : (this.#aF = a.next), (a.removed = !0), a.value
			}
			reset() {
				;(this.#aE = 0), (this.#aF = this.#aG = void 0)
			}
	...
	(a, b, c) => {
		...
		class e {
			...
			subscribe(a, b, c, f) {
				...
				if (1 === g.length) {
					for (let b of h) e.#aI(this.listeners[a].get(b), f).add(c)
					return
				}
				return (
					(this.#aK = !0),
			...
			extendTypeListeners(a, b) {
				let c = [d[a].subscribe]
				for (let [d, e] of b) this.#aM(a, d, e) && c.push(d)
				if (1 !== c.length)
					return (
						(this.#aK = !0),
						this.#aJ++,
			...
			unsubscribe(a, b, c, f) {
				...
				if (!b) return this.#aN([d[a].unsubscribe], NaN, () => g.clear())
				let h = e.#aH(b)
				if (!c)
					return this.#aN([d[a].unsubscribe, ...h], h.length, () => {
				...
				if (1 === i.length) {
					for (let a of h) e.#aI(g.get(a), f).delete(c)
					return
				}
				return this.#aN(i, i.length - 1, () => {
					for (let a of h) {
						let b = g.get(a)
						b &&
			...
			handleMessageReply(a) {
				return d[c.PUBSUB_TYPE.CHANNELS].message.equals(a[0])
					? (this.#aO(c.PUBSUB_TYPE.CHANNELS, a[2], a[1]), !0)
					: d[c.PUBSUB_TYPE.PATTERNS].message.equals(a[0])
						? (this.#aO(c.PUBSUB_TYPE.PATTERNS, a[3], a[2], a[1]), !0)
						: !!d[c.PUBSUB_TYPE.SHARDED].message.equals(a[0]) &&
							(this.#aO(c.PUBSUB_TYPE.SHARDED, a[2], a[1]), !0)
			}
			removeShardedListeners(a) {
				let b = this.listeners[c.PUBSUB_TYPE.SHARDED].get(a)
				return this.listeners[c.PUBSUB_TYPE.SHARDED].delete(a), this.#aL(), b
			}
			#aO(a, b, c, d) {
				let e = (d ?? c).toString(),
	...
	(a, b, c) => {
		...
		class m {
			#aP
			#aQ
			#aR = new e.DoublyLinkedList()
			#aS = new e.SinglyLinkedList()
			#aT
			#aU
			decoder
			#aV = new h.PubSub()
			get isPubSubActive() {
				return this.#aV.isActive
			}
			#aW
			constructor(a, b, c) {
				;(this.#aP = a), (this.#aQ = b), (this.#aT = c), (this.decoder = this.#aX())
			}
			#aY(a) {
				this.#aS.shift().resolve(a)
			}
			#aZ(a) {
				this.#aS.shift().reject(a)
			}
			#a$(a) {
				if (this.#aV.handleMessageReply(a)) return !0
				let b = h.PubSub.isShardedUnsubscribe(a)
				if (b && !this.#aS.length) {
					let b = a[1].toString()
					return this.#aT(b, this.#aV.removeShardedListeners(b)), !0
				}
				if (b || h.PubSub.isStatusReply(a)) {
					let b = this.#aS.head.value
					return (
						((Number.isNaN(b.channelsCounter) && 0 === a[2]) || 0 == --b.channelsCounter) &&
							this.#aS.shift().resolve(),
						!0
					)
				}
			}
			#a_() {
				return this.#aS.head.value.typeMapping ?? {}
			}
			#aX() {
				return new g.Decoder({
					onReply: (a) => this.#aY(a),
					onErrorReply: (a) => this.#aZ(a),
					onPush: (a) => {
						if (!this.#a$(a) && "invalidate" === a[0].toString() && this.#aW)
							if (null !== a[1]) for (let b of a[1]) this.#aW(b)
							else this.#aW(null)
					},
					getTypeMapping: () => this.#a_(),
				})
			}
			...
			addCommand(a, b) {
				return this.#aQ && this.#aR.length + this.#aS.length >= this.#aQ
						...
						: new Promise((c, d) => {
								...
								g &&
									((f.abort = {
										signal: g,
										listener: () => {
											this.#aR.remove(e), f.reject(new i.AbortError())
										},
									}),
									g.addEventListener("abort", f.abort.listener, { once: !0 })),
									(e = this.#aR.add(f, b?.asap))
							})
			}
			#a0(a, b = !1, c) {
				...
				2 === this.#aP &&
					((this.decoder.onReply = (a) => {
						if (Array.isArray(a)) {
							if (this.#a$(a)) return
							if (j.equals(a[0])) {
								let { resolve: b, typeMapping: c } = this.#aS.shift(),
			...
			subscribe(a, b, c, d) {
				...
				if (e) return this.#a1(), this.#a0(e)
			}
			#a2() {
				;(this.decoder.onReply = (a) => this.#aY(a)), (this.decoder.getTypeMapping = () => this.#a_())
			}
			unsubscribe(a, b, c, d) {
			...
			resubscribe(a) {
				let b = this.#aV.resubscribe()
				if (b.length) return this.#a1(), Promise.all(b.map((b) => this.#a0(b, !0, a)))
			}
			extendPubSubChannelListeners(a, b, c) {
				let d = this.#aV.extendChannelListeners(a, b, c)
				if (d) return this.#a1(), this.#a0(d)
			}
			extendPubSubListeners(a, b) {
				let c = this.#aV.extendTypeListeners(a, b)
				if (c) return this.#a1(), this.#a0(c)
			}
			getPubSubListeners(a) {
				return this.#aV.listeners[a]
			}
			monitor(a, b) {
					...
					this.#aR.add(
						{
							...
							abort: void 0,
							resolve: () => {
								this.#a3 ? (this.#a3 = a) : (this.decoder.onReply = a),
			...
			resetDecoder() {
				this.#a2(), this.decoder.reset()
			}
			#a3
			async reset(a, b) {
				return new Promise((c, d) => {
					;(this.#a3 = this.decoder.onReply),
						(this.decoder.onReply = (a) => {
							if (("string" == typeof a && "RESET" === a) || (a instanceof Buffer && k.equals(a))) {
								this.#a2(), (this.#a3 = void 0), this.#aV.reset(), this.#aS.shift().resolve(a)
								return
							}
							this.#a3(a)
						}),
			...
			*commandsToWrite() {
				...
				for (; a; ) {
					...
					try {
						...
						a.reject(b), (a = this.#aR.shift())
						continue
					}
					;(a.args = void 0),
						a.abort && (m.#a4(a), (a.abort = void 0)),
						(this.#aU = a.chainId),
						(a.chainId = void 0),
						this.#aS.push(a),
						yield b,
			...
			#a5(a) {
				for (let b of this.#aS) b.reject(a)
				this.#aS.reset()
			}
			static #a4(a) {
			...
			static #a6(a, b) {
				a.abort && m.#a4(a), a.reject(b)
			}
			flushWaitingForReply(a) {
				if ((this.resetDecoder(), this.#aV.reset(), this.#a5(a), this.#aU)) {
					for (; this.#aR.head?.value.chainId === this.#aU; ) m.#a6(this.#aR.shift(), a)
					this.#aU = void 0
				}
			}
			flushAll(a) {
				for (let b of (this.resetDecoder(), this.#aV.reset(), this.#a5(a), this.#aR)) m.#a6(b, a)
				this.#aR.reset()
			}
			isEmpty() {
				return 0 === this.#aR.length && 0 === this.#aS.length
			}
		}
		c.default = m
	},
		...
		class i {
			...
			static #ba(a, b) {
				...
				return function (...b) {
					...
					a.parseCommand(d, ...b)
					let e = d.redisArgs
					return (e.preserve = d.preserve), this.#bb(a, e, c)
				}
			}
			static extend(a) {
				return (0, g.attachConfig)({
					...
					commands: e.default,
					createCommand: i.#a7,
					createModuleCommand: i.#a8,
					createFunctionCommand: i.#a9,
					createScriptCommand: i.#ba,
					config: a,
				})
			}
			#bc
			...
			#bf
			constructor(a, b, c) {
				;(this.#bc = new f.default(c)), (this.#bd = a), (this.#be = b)
			}
			SELECT(a, b) {
				return (this.#bf = a), this.#bc.addCommand(["SELECT", a.toString()], b), this
			}
			select = this.SELECT
			addCommand(a, b) {
				return this.#bc.addCommand(a, b), this
			}
			#bb(a, b, c) {
				return this.#bc.addScript(a, b, c), this
			}
			async exec(a = !1) {
				return a ? this.execAsPipeline() : this.#bc.transformReplies(await this.#bd(this.#bc.queue, this.#bf))
			}
			EXEC = this.exec
			execTyped(a = !1) {
				return this.exec(a)
			...
			async execAsPipeline() {
				return 0 === this.#bc.queue.length
					? []
					: this.#bc.transformReplies(await this.#be(this.#bc.queue, this.#bf))
			}
			execAsPipelineTyped() {
	...
	(a, b, c) => {
		...
		class h {
			...
			static #a7(a, b, c) {
				...
				return function (...b) {
					let c = [a],
						e = h.#bg(c, b),
						f = this.#bh.sendCommand(c)
					e
						? f.then((a) => e(null, d ? d(a) : a)).catch((a) => e(a))
						: f.catch((a) => this.#bh.emit("error", a))
				}
			}
			#bh
			#bi
			constructor(a) {
				...
				for (const [a, c] of Object.entries(f.default)) this[a] = h.#a7(a, c, b)
				this.#bi = i.factory(b)
			}
			sendCommand(...a) {
				let b = [],
					c = h.#bg(b, a),
					d = this.#bh.sendCommand(b)
				c ? d.then((a) => c(null, a)).catch((a) => c(a)) : d.catch((a) => this.#bh.emit("error", a))
			}
			multi() {
		...
		class i {
			static #a7(a, b, c) {
				...
				return function (...b) {
					let c = [a]
					return h.pushArguments(c, b), this.#bc.addCommand(c, d), this
				}
			}
			static factory(a) {
				let b = class extends i {}
				for (let [c, d] of Object.entries(f.default)) b.prototype[c] = i.#a7(c, d, a)
				return (a) => new b(a)
			}
			#bc = new g.default()
			#bh
			...
			sendCommand(...a) {
				let b = []
				return h.pushArguments(b, a), this.#bc.addCommand(b), this
			}
			exec(a) {
				let b = this.#bh._executeMulti(this.#bc.queue)
				a
					? b.then((b) => a(null, this.#bc.transformReplies(b))).catch((b) => a?.(b))
					: b.catch((a) => this.#bh.emit("error", a))
			}
		}
	},
	66486,
	(a, b, c) => {
		...
		class g {
			...
			snapshot() {
				return e.of(this.#bj, this.#bk, this.#bl, this.#bm, this.#bn, this.#bo)
			}
			static create() {
				return new g()
			}
		...
		class h {
			...
			#bq
			constructor(a) {
				0 == a ? (this.#bq = 0) : (this.#bq = Date.now() + a)
			}
			invalidate() {
				this.#bp = !0
			}
			validate() {
				return !this.#bp && (0 == this.#bq || Date.now() < this.#bq)
			}
		}
		class i extends h {
			#br
		...
		class l extends k {
			...
			#bv
			recordEvictions(a) {
				this.#bv.recordEvictions(a)
			}
			recordHits(a) {
				this.#bv.recordHits(a)
			}
			recordMisses(a) {
				this.#bv.recordMisses(a)
			}
			constructor(a) {
				super(),
					(this.#bt = new Map()),
			...
			async handleCache(a, b, c, d, e) {
				let f,
					...
					k = this.get(h)
				if (k)
					if (k instanceof i) return this.#bv.recordHits(1), structuredClone(k.value)
					else if (k instanceof j) this.#bv.recordMisses(1), (f = await k.promise)
					else throw Error("unknown cache entry type")
				else {
					this.#bv.recordMisses(1)
					...
					try {
						...
						this.#bv.recordLoadSuccess(a)
					} catch (b) {
						let a = performance.now() - d
						throw (this.#bv.recordLoadFailure(a), k.validate() && this.delete(h), b)
					}
				}
				return (
			...
			invalidate(a) {
				...
				let b = this.#bu.get(a.toString())
				if (b) {
					for (let a of b) {
						let b = this.#bt.get(a)
						b && b.invalidate(), this.#bt.delete(a)
					}
					this.#bu.delete(a.toString())
				}
			...
			clear(a = !0) {
				...
				this.#bt.clear(),
					this.#bu.clear(),
					a ? this.#bv instanceof f || (this.#bv = g.create()) : b > 0 && this.#bv.recordEvictions(b)
			}
			get(a) {
				let b = this.#bt.get(a)
				if (b && !b.validate()) {
					this.delete(a), this.#bv.recordEvictions(1), this.emit("cache-evict", a)
					return
				}
				return void 0 !== b && this.lru && (this.#bt.delete(a), this.#bt.set(a, b)), b
			}
			delete(a) {
				let b = this.#bt.get(a)
				b && (b.invalidate(), this.#bt.delete(a))
			...
			has(a) {
				return this.#bt.has(a)
			}
			set(a, b, c) {
				let d = this.#bt.size,
					e = this.#bt.get(a)
				for (let f of (e && (d--, e.invalidate()),
				this.maxEntries > 0 && d >= this.maxEntries && (this.deleteOldest(), this.#bv.recordEvictions(1)),
				this.#bt.set(a, b),
				c))
					this.#bu.has(f.toString()) || this.#bu.set(f.toString(), new Set()),
						this.#bu.get(f.toString()).add(a)
			}
			size() {
				return this.#bt.size
			}
			...
			deleteOldest() {
				let a = this.#bt[Symbol.iterator]().next()
				if (!a.done) {
					let b = a.value[0],
						c = this.#bt.get(b)
					c && c.invalidate(), this.#bt.delete(b)
				}
			}
			entryEntries() {
				return this.#bt.entries()
			}
			keySetEntries() {
		...
		class m extends l {
			...
			get(a) {
				if (!this.#bw) return super.get(a)
			}
			has(a) {
				return !this.#bw && super.has(a)
			}
			onPoolClose() {
				this.clear()
			}
		...
		class o extends i {
			...
			validate() {
				...
				return (
					this.#bx && (a = a && this.#bx.client.isReady && this.#bx.client.socketEpoch == this.#bx.epoch), a
				)
			}
		}
		class p extends j {
			...
			validate() {
				return super.validate() && this.#bx.client.isReady && this.#bx.client.socketEpoch == this.#bx.epoch
			}
		}
	...
	(a, b, c) => {
		...
		Object.defineProperty(c, "__esModule", { value: !0 }),
			(c.default = class {
				...
				#bz
				get(a) {
					return JSON.stringify(a, d()) === this.#bz ? this.#by : void 0
				}
				set(a, b) {
					;(this.#by = b), (this.#bz = JSON.stringify(a, d()))
				}
			})
	},
	60823,
	(a, b, c) => {
		...
		class o extends g.EventEmitter {
				...
				return (
					c ||
						(((c = (0, j.attachConfig)({
							...
							commands: e.default,
							createCommand: o.#a7,
							createModuleCommand: o.#a8,
							createFunctionCommand: o.#a9,
							createScriptCommand: o.#ba,
							config: a,
			...
			static #bB = { minimum: 1, maximum: 100, acquireTimeout: 3e3, cleanupDelay: 3e3 }
			#bC
			#bD
			#bE = new h.SinglyLinkedList()
			get idleClients() {
				return this._self.#bE.length
			}
			#bF = new h.DoublyLinkedList()
			get clientsInUse() {
				return this._self.#bF.length
			}
			get totalClients() {
				return this._self.#bE.length + this._self.#bF.length
			}
			#bG = new h.SinglyLinkedList()
			get tasksQueueLength() {
				return this._self.#bG.length
			}
			#au = !1
			get isOpen() {
				return this._self.#au
			}
			#bH = !1
			get isClosing() {
				return this._self.#bH
			}
			#bI
			get clientSideCache() {
			...
			constructor(a, b) {
				if ((super(), (this.#bD = { ...o.#bB, ...b }), b?.clientSideCache))
					if ((void 0 === a && (a = {}), b.clientSideCache instanceof l.PooledClientSideCacheProvider))
						this.#bI = a.clientSideCache = b.clientSideCache
					else {
						const c = b.clientSideCache
						this.#bI = a.clientSideCache = new l.BasicPooledClientSideCache(c)
					}
				this.#bC = f.default.factory(a).bind(void 0, a)
			}
			_self = this
			_commandOptions
			...
			withTypeMapping(a) {
				return this._self.#bJ("typeMapping", a)
			}
			withAbortSignal(a) {
				return this._self.#bJ("abortSignal", a)
			}
			asap() {
				return this._self.#bJ("asap", !0)
			}
			async connect() {
				if (this._self.#au) return
				this._self.#au = !0
				let a = []
				for (; a.length < this._self.#bD.minimum; ) a.push(this._self.#bK())
				try {
					await Promise.all(a)
				} catch (a) {
			...
			async #bK() {
				let a = this._self.#bF.push(this._self.#bC().on("error", (a) => this.emit("error", a)))
				try {
					let b = a.value
					await b.connect()
				} catch (b) {
					throw (this._self.#bF.remove(a), b)
				}
				this._self.#bL(a)
			}
			execute(a) {
				return new Promise((b, c) => {
					let d = this._self.#bE.shift(),
						{ tail: e } = this._self.#bG
					if (!d) {
						let d
						this._self.#bD.acquireTimeout > 0 &&
							(d = setTimeout(() => {
								this._self.#bG.remove(f, e), c(new i.TimeoutError("Timeout waiting for a client"))
							}, this._self.#bD.acquireTimeout))
						let f = this._self.#bG.push({ timeout: d, resolve: b, reject: c, fn: a })
						this.totalClients < this._self.#bD.maximum && this._self.#bK()
						return
					}
					let f = this._self.#bF.push(d)
					this._self.#bM(f, b, c, a)
				})
			}
			#bM(a, b, c, d) {
				let e = d(a.value)
				e instanceof Promise ? (e.then(b, c), e.finally(() => this.#bL(a))) : (b(e), this.#bL(a))
			}
			#bL(a) {
				let b = this.#bG.shift()
				if (b) {
					clearTimeout(b.timeout), this.#bM(a, b.resolve, b.reject, b.fn)
					return
				}
				this.#bF.remove(a), this.#bE.push(a.value), this.#bN()
			}
			cleanupTimeout
			#bN() {
				this.totalClients <= this.#bD.minimum ||
					(clearTimeout(this.cleanupTimeout),
					(this.cleanupTimeout = setTimeout(() => this.#bO(), this.#bD.cleanupDelay)))
			}
			#bO() {
				let a = Math.min(this.#bE.length, this.totalClients - this.#bD.minimum)
				for (let b = 0; b < a; b++) this.#bE.shift().destroy()
			}
			sendCommand(a, b) {
			...
			multi = this.MULTI
			async close() {
				if (!this._self.#bH && this._self.#au) {
					this._self.#bH = !0
					try {
						let a = []
						for (let b of this._self.#bE) a.push(b.close())
						for (let b of this._self.#bF) a.push(b.close())
						await Promise.all(a), this.#bI?.onPoolClose(), this._self.#bE.reset(), this._self.#bF.reset()
					} catch (a) {
					} finally {
						this._self.#bH = !1
					}
			...
			destroy() {
				for (let a of this._self.#bE) a.destroy()
				for (let a of (this._self.#bE.reset(), this._self.#bF)) a.destroy()
				this._self.#bI?.onPoolClose(), this._self.#bF.reset(), (this._self.#au = !1)
			}
		}
		c.RedisClientPool = o
	},
	...
	(a, b, c) => {
		...
		class x extends j.EventEmitter {
				...
				return (
					b ||
						(((b = (0, k.attachConfig)({
							...
							commands: f.default,
							createCommand: d.#a7,
							createModuleCommand: d.#a8,
							createFunctionCommand: d.#a9,
							createScriptCommand: d.#ba,
							config: a,
			...
			get options() {
				return this._self.#bD
			}
			get isOpen() {
				return this._self.#at.isOpen
			}
			get isReady() {
				return this._self.#at.isReady
			}
			get isPubSubActive() {
				return this._self.#bP.isPubSubActive
			}
			get socketEpoch() {
				return this._self.#at.socketEpoch
			}
			get isWatching() {
				return void 0 !== this._self.#bS
			}
			get isDirtyWatch() {
				return void 0 !== this._self.#bR
			}
			setDirtyWatch(a) {
				this._self.#bR = a
			}
			constructor(a) {
				if (
					...
					if (a.clientSideCache instanceof t.ClientSideCacheProvider) this.#bI = a.clientSideCache
					else {
						const b = a.clientSideCache
						this.#bI = new t.BasicClientSideCache(b)
					}
					this.#bP.setInvalidateCallback(this.#bI.invalidate.bind(this.#bI))
				}
			}
			#bU(a) {
			...
			#bV(a) {
				...
				return (
					a?.database && (this._self.#bf = a.database),
					a?.commandOptions && (this._commandOptions = a.commandOptions),
					a
				)
			}
			#bW() {
				return new i.default(this.#bD?.RESP ?? 2, this.#bD?.commandsQueueMaxLength, (a, b) =>
					this.emit("sharded-channel-moved", a, b),
				)
			}
			reAuthenticate = async (a) => {
				;(this.isPubSubActive && !this.#bD?.RESP) ||
			...
			async #bZ(a, b) {
				...
				for (let { cmd: e, errorHandler: f } of (b && d.reverse(), d))
					c.push(this.#bP.addCommand(e, { chainId: a, asap: b }).catch(f))
				return c
			}
			async #b$() {
				let a = [],
					b = this.#bD?.credentialsProvider
				if (this.#bD?.RESP) {
					let c = {}
					...
					if (b && "streaming-credentials-provider" === b.type) {
						let [a, d] = await this.#bY(b)
						;(this.#bT = d),
							a.password && (c.AUTH = { username: a.username ?? "default", password: a.password })
					}
					this.#bD.name && (c.SETNAME = this.#bD.name),
						a.push({ cmd: (0, s.parseArgs)(p.default, this.#bD.RESP, c) })
				} else {
					if (b && "async-credentials-provider" === b.type) {
					...
					this.#bD?.name && a.push({ cmd: (0, s.parseArgs)(f.default.CLIENT_SETNAME, this.#bD.name) })
				}
				return (
					0 !== this.#bf && a.push({ cmd: ["SELECT", this.#bf.toString()] }),
					this.#bD?.readonly && a.push({ cmd: (0, s.parseArgs)(f.default.READONLY) }),
					this.#bD?.disableClientInfo ||
						...
						a.push({
							cmd: [
								...
								"SETINFO",
								"LIB-NAME",
								this.#bD?.clientInfoTag ? `node-redis(${this.#bD.clientInfoTag})` : "node-redis",
							],
							errorHandler: () => {},
						})),
					this.#bI && a.push({ cmd: this.#bI.trackingOn() }),
					a
				)
			}
			#bX() {
				let a = async () => {
					let a = [],
						...
						c = this.#bP.resubscribe(b)
					if (
						(c && a.push(c),
						this.#bQ &&
							a.push(
								this.#bP.monitor(this.#bQ, {
									typeMapping: this._commandOptions?.typeMapping,
									chainId: b,
									asap: !0,
								}),
							),
						a.push(...(await this.#bZ(b, !0))),
						a.length)
					)
						return this.#b_(), Promise.all(a)
				}
				return new g.default(a, this.#bD?.socket)
					.on("data", (a) => {
						try {
							this.#bP.decoder.write(a)
						} catch (a) {
							this.#bP.resetDecoder(), this.emit("error", a)
						}
					})
					.on("error", (a) => {
						this.emit("error", a),
							this.#bI?.onError(),
							this.#at.isOpen && !this.#bD?.disableOfflineQueue
								? this.#bP.flushWaitingForReply(a)
								: this.#bP.flushAll(a)
					})
					.on("connect", () => this.emit("connect"))
					.on("ready", () => {
						this.emit("ready"), this.#b0(), this.#b1()
					})
			...
			createPool(a) {
				return r.RedisClientPool.create(this._self.#bD, a)
			}
			duplicate(a) {
			...
			async connect() {
				return await this._self.#at.connect(), this
			}
			async _executeCommand(a, b, c, d) {
				let e = this._self.#bI,
					f = this._self.#bD?.commandOptions === c,
			...
			sendCommand(a, b) {
				if (!this._self.#at.isOpen) return Promise.reject(new l.ClientClosedError())
				if (!this._self.#at.isReady && this._self.#bD?.disableOfflineQueue)
					return Promise.reject(new l.ClientOfflineError())
				let c = this._self.#bP.addCommand(a, b)
				return this._self.#b3(), c
			}
			async SELECT(a) {
				await this.sendCommand(["SELECT", a.toString()]), (this._self.#bf = a)
			}
			select = this.SELECT
			#b4(a) {
				return void 0 === a ? Promise.resolve() : (this.#b3(), a)
			}
			SUBSCRIBE(a, b, c) {
				return this._self.#b4(this._self.#bP.subscribe(n.PUBSUB_TYPE.CHANNELS, a, b, c))
			}
			subscribe = this.SUBSCRIBE
			UNSUBSCRIBE(a, b, c) {
				return this._self.#b4(this._self.#bP.unsubscribe(n.PUBSUB_TYPE.CHANNELS, a, b, c))
			}
			unsubscribe = this.UNSUBSCRIBE
			PSUBSCRIBE(a, b, c) {
				return this._self.#b4(this._self.#bP.subscribe(n.PUBSUB_TYPE.PATTERNS, a, b, c))
			}
			pSubscribe = this.PSUBSCRIBE
			PUNSUBSCRIBE(a, b, c) {
				return this._self.#b4(this._self.#bP.unsubscribe(n.PUBSUB_TYPE.PATTERNS, a, b, c))
			}
			pUnsubscribe = this.PUNSUBSCRIBE
			SSUBSCRIBE(a, b, c) {
				return this._self.#b4(this._self.#bP.subscribe(n.PUBSUB_TYPE.SHARDED, a, b, c))
			}
			sSubscribe = this.SSUBSCRIBE
			SUNSUBSCRIBE(a, b, c) {
				return this._self.#b4(this._self.#bP.unsubscribe(n.PUBSUB_TYPE.SHARDED, a, b, c))
			}
			sUnsubscribe = this.SUNSUBSCRIBE
			async WATCH(a) {
				let b = await this._self.sendCommand((0, s.pushVariadicArguments)(["WATCH"], a))
				return (this._self.#bS ??= this._self.socketEpoch), b
			}
			watch = this.WATCH
			async UNWATCH() {
				let a = await this._self.sendCommand(["UNWATCH"])
				return (this._self.#bS = void 0), a
			}
			unwatch = this.UNWATCH
			getPubSubListeners(a) {
				return this._self.#bP.getPubSubListeners(a)
			}
			extendPubSubChannelListeners(a, b, c) {
				return this._self.#b4(this._self.#bP.extendPubSubChannelListeners(a, b, c))
			}
			extendPubSubListeners(a, b) {
				return this._self.#b4(this._self.#bP.extendPubSubListeners(a, b))
			}
			#b_() {
				this.#at.write(this.#bP.commandsToWrite())
			}
			#b5
			#b3() {
				this.#at.isReady &&
					!this.#b5 &&
					(this.#b5 = setImmediate(() => {
						this.#b_(), (this.#b5 = void 0)
					}))
			}
			#b1() {
				this.#bP.isWaitingToWrite() && this.#b3()
			}
			async _executePipeline(a, b) {
				...
				this._self.#b3()
				let e = await d
				return void 0 !== b && (this._self.#bf = b), e
			}
			async _executeMulti(a, b) {
				let c = this._self.#bR
				this._self.#bR = void 0
				let d = this._self.#bS
				if (((this._self.#bS = void 0), !this._self.#at.isOpen)) throw new l.ClientClosedError()
				...
				let e = this._commandOptions?.typeMapping,
					...
					g = [this._self.#bP.addCommand(["MULTI"], { chainId: f })]
				for (let { args: b } of a) g.push(this._self.#bP.addCommand(b, { chainId: f, typeMapping: e }))
				g.push(this._self.#bP.addCommand(["EXEC"], { chainId: f })), this._self.#b3()
				let h = await Promise.all(g),
					i = h[h.length - 1]
				if (null === i) throw new l.WatchError()
				return void 0 !== b && (this._self.#bf = b), i
			}
			MULTI() {
				return new this.Multi(
			...
			async MONITOR(a) {
				let b = this._self.#bP.monitor(a, { typeMapping: this._commandOptions?.typeMapping })
				this._self.#b3(), await b, (this._self.#bQ = a)
			}
			monitor = this.MONITOR
			async reset() {
				let a = Symbol("Reset Chain"),
					b = [this._self.#bP.reset(a)],
					c = this._self.#bD?.database ?? 0
				this._self.#bT?.dispose(),
					(this._self.#bT = null),
					b.push(...(await this._self.#bZ(a, !1))),
					this._self.#b3(),
					await Promise.all(b),
					(this._self.#bf = c),
					(this._self.#bQ = void 0),
					(this._self.#bR = void 0),
			...
			resetIfDirty() {
				let a = !1
				if (
					(this._self.#bf !== (this._self.#bD?.database ?? 0) &&
						(console.warn("Returning a client with a different selected DB"), (a = !0)),
					this._self.#bQ && (console.warn("Returning a client with active MONITOR"), (a = !0)),
					this._self.#bP.isPubSubActive && (console.warn("Returning a client with active PubSub"), (a = !0)),
					(this._self.#bR || this._self.#bS) &&
			...
			QUIT() {
				return (
					this._self.#bT?.dispose(),
					(this._self.#bT = null),
					this._self.#at.quit(async () => {
						clearTimeout(this._self.#b2)
						let a = this._self.#bP.addCommand(["QUIT"])
						return this._self.#b3(), a
					})
				)
			}
			quit = this.QUIT
			...
			close() {
				return new Promise((a) => {
					if (
						(clearTimeout(this._self.#b2),
						this._self.#at.close(),
						this._self.#bI?.onClose(),
						this._self.#bP.isEmpty())
					)
						return this._self.#at.destroySocket(), a()
					let b = () => {
						this._self.#bP.isEmpty() && (this._self.#at.off("data", b), this._self.#at.destroySocket(), a())
					}
					this._self.#at.on("data", b), this._self.#bT?.dispose(), (this._self.#bT = null)
				})
			}
			destroy() {
				clearTimeout(this._self.#b2),
					this._self.#bP.flushAll(new l.DisconnectsClientError()),
					this._self.#at.destroy(),
					this._self.#bI?.onClose(),
					this._self.#bT?.dispose(),
					(this._self.#bT = null)
			}
		...
		class k {
			...
			constructor(a, b) {
				this.#bU(a),
					...
					(this.#bC = g.default.factory(this.#bD)),
					(this.#b7 = b)
			}
			async connect() {
				if (this.#au) throw Error("Cluster already open")
				this.#au = !0
				try {
					await this.#b8()
				} catch (a) {
			...
			async #b8() {
				let a = Math.floor(Math.random() * this.#bD.rootNodes.length)
				for (let b = a; b < this.#bD.rootNodes.length; b++) {
					if (!this.#au) throw Error("Cluster closed")
					if (await this.#b9(this.#bD.rootNodes[b])) return
				}
				for (let b = 0; b < a; b++) {
					if (!this.#au) throw Error("Cluster closed")
					if (await this.#b9(this.#bD.rootNodes[b])) return
			...
			async #b9(a) {
				...
				try {
					let b = new Set(),
						c = [],
						d = !0 !== this.#bD.minimizeConnections,
						e = await this.#cb(a)
					for (let { from: a, to: f, master: g, replicas: h } of (this.#ca(), e)) {
						let e = { master: this.#cc(g, !1, d, b, c) }
						this.#bD.useReplicas && (e.replicas = h.map((a) => this.#cc(a, !0, d, b, c)))
					...
					if (this.pubSubNode && !b.has(this.pubSubNode.address)) {
						...
						this.pubSubNode.client.destroy(),
							(a.size || b.size) &&
								c.push(this.#cd({ [h.PUBSUB_TYPE.CHANNELS]: a, [h.PUBSUB_TYPE.PATTERNS]: b }))
					}
			...
			async #cb(a) {
				...
				let c = await this.#bC(b)
					.on("error", (a) => this.#b7("error", a))
					.connect()
				try {
			...
			#cf(a) {
				switch (typeof this.#bD.nodeAddressMap) {
					case "object":
						return this.#bD.nodeAddressMap[a]
					case "function":
						return this.#bD.nodeAddressMap(a)
				}
			}
			#ce(a) {
				let b
				return this.#bD.defaults
					? ((b = this.#bD.defaults.socket ? { ...this.#bD.defaults.socket, ...a?.socket } : a?.socket),
						{ ...this.#bD.defaults, ...a, socket: b })
					: a
			}
			#cc(a, b, c, d, e) {
				let f = `${a.host}:${a.port}`,
			...
			#ch(a, b = a.readonly) {
				return this.#bC(
					this.#ce({
						...
						RESP: this.#bD.RESP,
						socket: this.#cf(a.address) ?? { host: a.host, port: a.port },
						readonly: b,
					}),
				).on("error", (a) => console.error(a))
			}
			#cg(a, b) {
				let c = (a.client = this.#ch(a, b))
				return (a.connectPromise = c.connect().finally(() => (a.connectPromise = void 0)))
			}
			nodeClient(a) {
				return a.connectPromise ?? a.client ?? this.#cg(a)
			}
			#ci
			async rediscover(a) {
				return (this.#ci ??= this.#cj(a).finally(() => (this.#ci = void 0))), this.#ci
			}
			async #cj(a) {
				if (!(await this.#b9(a.options))) return this.#b8()
			}
			quit() {
				return this.#ck((a) => a.quit())
			}
			disconnect() {
				return this.#ck((a) => a.disconnect())
			}
			close() {
				return this.#ck((a) => a.close())
			}
			destroy() {
				for (let a of ((this.#au = !1), this.#cl())) a.destroy()
			...
			*#cl() {
			...
			async #ck(a) {
				this.#au = !1
				let b = []
				for (let c of this.#cl()) b.push(a(c))
			...
			*#cm() {
			...
			_randomNodeIterator
			getRandomNode() {
				return (this._randomNodeIterator ??= this.#cm()), this._randomNodeIterator.next().value
			}
			*#cn(a) {
			...
			getSlotRandomNode(a) {
				let b = this.slots[a]
				return b.replicas?.length ? ((b.nodesIterator ??= this.#cn(b)), b.nodesIterator.next().value) : b.master
			}
			...
			getPubSubClient() {
				return this.pubSubNode ? (this.pubSubNode.connectPromise ?? this.pubSubNode.client) : this.#cd()
			}
			async #cd(a) {
			...
			getShardedPubSubClient(a) {
				...
				return b.pubSub ? (b.pubSub.connectPromise ?? b.pubSub.client) : this.#co(b)
			}
			async #co(a) {
				let b = this.#ch(a, !1).on("server-sunsubscribe", async (a, c) => {
					try {
						...
						this.#b7("sharded-shannel-moved-error", b, a, c)
					}
				})
				return (
					(a.pubSub = {
		...
		class i {
			...
			static #ba(a, b) {
				...
				return function (...b) {
					...
					e.preserve = d.preserve
					let f = d.firstKey
					return this.#bb(f, a.IS_READ_ONLY, a, e, c)
				}
			}
			static extend(a) {
				return (0, g.attachConfig)({
			...
			#cq = !0
			constructor(a, b, c, d) {
				;(this.#bc = new f.default(d)), (this.#bd = a), (this.#be = b), (this.#cp = c)
			}
			#cr(a, b) {
				;(this.#cp ??= a), (this.#cq &&= b)
			}
			addCommand(a, b, c, d) {
				return this.#cr(a, b), this.#bc.addCommand(c, d), this
			}
			#bb(a, b, c, d, e) {
				return this.#cr(a, b), this.#bc.addScript(c, d, e), this
			}
			async exec(a = !1) {
				return a
					? this.execAsPipeline()
					: this.#bc.transformReplies(await this.#bd(this.#cp, this.#cq, this.#bc.queue))
			}
			EXEC = this.exec
			execTyped(a = !1) {
				return this.exec(a)
			...
			async execAsPipeline() {
				return 0 === this.#bc.queue.length
					? []
					: this.#bc.transformReplies(await this.#be(this.#cp, this.#cq, this.#bc.queue))
			}
			execAsPipelineTyped() {
				return this.execAsPipeline()
			}
				...
				return (
					b ||
						(((b = (0, g.attachConfig)({
							...
							commands: e.default,
							createCommand: n.#a7,
							createModuleCommand: n.#a8,
							createFunctionCommand: n.#a9,
							createScriptCommand: n.#ba,
							config: a,
		...
		class i {
			...
			static _createScriptCommand(a, b) {
				...
				return function (...b) {
					...
					a.parseCommand(d, ...b)
					let e = d.redisArgs
					return (e.preserve = d.preserve), this.#bb(a.IS_READ_ONLY, a, e, c)
				}
			}
			static extend(a) {
				return (0, g.attachConfig)({
			...
			#cq = !0
			constructor(a, b) {
				;(this.#bc = new f.default(b)), (this.#cs = a)
			}
			#cr(a) {
				this.#cq &&= a
			}
			addCommand(a, b, c) {
				return this.#cr(a), this.#bc.addCommand(b, c), this
			}
			#bb(a, b, c, d) {
				return this.#cr(a), this.#bc.addScript(b, c, d), this
			}
			async exec(a = !1) {
				return a
					? this.execAsPipeline()
					: this.#bc.transformReplies(await this.#cs._executeMulti(this.#cq, this.#bc.queue))
			}
			EXEC = this.exec
			execTyped(a = !1) {
				return this.exec(a)
			...
			async execAsPipeline() {
				return 0 === this.#bc.queue.length
					? []
					: this.#bc.transformReplies(await this.#cs._executePipeline(this.#cq, this.#bc.queue))
			}
			execAsPipelineTyped() {
				return this.execAsPipeline()
			}
	...
	(a, b, c) => {
		...
		class h extends e.default {
			...
			#cx
			constructor(a, b) {
				super(), (this.#ct = a), (this.#cu = b)
			}
			#ch() {
				if (void 0 === this.#cv) throw Error("pubSubProxy: didn't define node to do pubsub against")
				return new g.default({
					...this.#ct,
					socket: { ...this.#ct.socket, host: this.#cv.host, port: this.#cv.port },
				})
			}
			async #cd(a = !1) {
				let b = this.#ch().on("error", this.#cu),
					c = b
						.connect()
						.then(async (b) =>
							this.#cw?.client !== b ||
							(a &&
								this.#cx &&
								(await Promise.all([
									b.extendPubSubListeners(f.PUBSUB_TYPE.CHANNELS, this.#cx[f.PUBSUB_TYPE.CHANNELS]),
									b.extendPubSubListeners(f.PUBSUB_TYPE.PATTERNS, this.#cx[f.PUBSUB_TYPE.PATTERNS]),
								])),
							this.#cw.client !== b)
								? (b.destroy(), this.#cw?.connectPromise)
								: ((this.#cw.connectPromise = void 0), b),
						)
						.catch((a) => {
							throw ((this.#cw = void 0), a)
						})
				return (this.#cw = { client: b, connectPromise: c }), c
			}
			#cy() {
				return this.#cw ? (this.#cw.connectPromise ?? this.#cw.client) : this.#cd()
			}
			async changeNode(a) {
				;(this.#cv = a),
					this.#cw &&
						(void 0 === this.#cw.connectPromise &&
							((this.#cx = {
								[f.PUBSUB_TYPE.CHANNELS]: this.#cw.client.getPubSubListeners(f.PUBSUB_TYPE.CHANNELS),
								[f.PUBSUB_TYPE.PATTERNS]: this.#cw.client.getPubSubListeners(f.PUBSUB_TYPE.PATTERNS),
							}),
							this.#cw.client.destroy()),
						await this.#cd(!0))
			}
			#cz(a) {
				let b = this.#cy()
				return b instanceof g.default
					...
					: b
							...
							.catch((a) => {
								throw (
									(this.#cw?.client.isPubSubActive &&
										(this.#cw.client.destroy(), (this.#cw = void 0)),
									a)
								)
							})
			}
			subscribe(a, b, c) {
				return this.#cz((d) => d.SUBSCRIBE(a, b, c))
			}
			#cA(a) {
				return this.#cz(async (b) => {
					let c = await a(b)
					return b.isPubSubActive || (b.destroy(), (this.#cw = void 0)), c
				})
			}
			async unsubscribe(a, b, c) {
				return this.#cA((d) => d.UNSUBSCRIBE(a, b, c))
			}
			async pSubscribe(a, b, c) {
				return this.#cz((d) => d.PSUBSCRIBE(a, b, c))
			}
			async pUnsubscribe(a, b, c) {
				return this.#cA((d) => d.PUNSUBSCRIBE(a, b, c))
			}
			destroy() {
				;(this.#cx = void 0),
					void 0 !== this.#cw && (this.#cw.connectPromise || this.#cw.client.destroy(), (this.#cw = void 0))
			}
		}
		c.PubSubProxy = h
	},
	...
	(a, b, c) => {
		...
		let d = a.r(69821)
		class e {
			#cB = new d.SinglyLinkedList()
			#bP = new d.SinglyLinkedList()
			push(a) {
				let b = this.#bP.shift()
				void 0 !== b ? b(a) : this.#cB.push(a)
			}
			shift() {
				return this.#cB.shift()
			}
			wait() {
				return new Promise((a) => this.#bP.push(a))
			}
		}
		c.WaitQueue = e
	},
	...
	(a, b, c) => {
		...
		class p {
			...
			_self
			get isOpen() {
				return this._self.#cD.isOpen
			}
			get isReady() {
				return this._self.#cD.isReady
			}
			get commandOptions() {
				return this._self.#cE
			}
			#cE
			constructor(a, b, c) {
				;(this._self = this), (this.#cD = a), (this.#cC = b), (this.#cE = c)
			}
			static factory(a) {
			...
			_commandOptionsProxy(a, b) {
				let c = Object.create(this)
				return (c._commandOptions = Object.create(this._self.#cE ?? null)), (c._commandOptions[a] = b), c
			}
			withTypeMapping(a) {
				return this._commandOptionsProxy("typeMapping", a)
			}
			async _execute(a, b) {
				if (void 0 === this._self.#cC) throw Error("Attempted execution on released RedisSentinelClient lease")
				return await this._self.#cD.execute(b, this._self.#cC)
			}
			...
			unwatch = this.UNWATCH
			release() {
				if (void 0 === this._self.#cC) throw Error("RedisSentinelClient lease already released")
				let a = this._self.#cD.releaseClientLease(this._self.#cC)
				return (this._self.#cC = void 0), a
			}
		}
		...
		class q extends e.EventEmitter {
			...
			#cI
			get clientSideCache() {
				return this._self.#cD.clientSideCache
			}
			constructor(a) {
				super(),
					(this._self = this),
					(this.#bD = a),
					a.commandOptions && (this.#cE = a.commandOptions),
					(this.#cD = new r(a)),
					this.#cD.on("error", (a) => this.emit("error", a)),
					this.#cD.on("topology-change", (a) => {
			...
			_commandOptionsProxy(a, b) {
				let c = Object.create(this)
				return (c._self.#cE = { ...(this._self.#cE || {}), [a]: b }), c
			}
			withTypeMapping(a) {
				return this._commandOptionsProxy("typeMapping", a)
			}
			async connect() {
				return (
					await this._self.#cD.connect(),
					this._self.#bD.reserveClient && (this._self.#cG = await this._self.#cD.getClientLease()),
					this
				)
			}
			async _execute(a, b) {
				let c
				;(!a || !this._self.#cD.useReplicas) &&
					(this._self.#cG
						? (c = this._self.#cG)
						: ((this._self.#cI ??= await this._self.#cD.getClientLease()),
							(c = this._self.#cI),
							this._self.#cH++))
				try {
					return await this._self.#cD.execute(b, c)
				} finally {
					if (void 0 !== c && c === this._self.#cI && 0 == --this._self.#cH) {
						let a = this._self.#cD.releaseClientLease(c)
						;(this._self.#cI = void 0), a && (await a)
					}
				}
			}
			async use(a) {
				let b = await this._self.#cD.getClientLease()
				try {
					return await a(p.create(this._self.#bD, this._self.#cD, b, this._self.#cE))
				} finally {
					let a = this._self.#cD.releaseClientLease(b)
					a && (await a)
				}
			}
			async sendCommand(a, b, c) {
			...
			multi = this.MULTI
			async close() {
				return this._self.#cD.close()
			}
			destroy() {
				return this._self.#cD.destroy()
			}
			async SUBSCRIBE(a, b, c) {
				return this._self.#cD.subscribe(a, b, c)
			}
			subscribe = this.SUBSCRIBE
			async UNSUBSCRIBE(a, b, c) {
				return this._self.#cD.unsubscribe(a, b, c)
			}
			unsubscribe = this.UNSUBSCRIBE
			async PSUBSCRIBE(a, b, c) {
				return this._self.#cD.pSubscribe(a, b, c)
			}
			pSubscribe = this.PSUBSCRIBE
			async PUNSUBSCRIBE(a, b, c) {
				return this._self.#cD.pUnsubscribe(a, b, c)
			}
			pUnsubscribe = this.PUNSUBSCRIBE
			async acquire() {
				let a = await this._self.#cD.getClientLease()
				return p.create(this._self.#bD, this._self.#cD, a, this._self.#cE)
			}
			getSentinelNode() {
				return this._self.#cD.getSentinelNode()
			}
			getMasterNode() {
				return this._self.#cD.getMasterNode()
			}
			getReplicaNodes() {
				return this._self.#cD.getReplicaNodes()
			}
			setTracer(a) {
				a
					? (this._self.#cF = (b) => {
		...
		class r extends e.EventEmitter {
			...
			constructor(a) {
				if (
					...
					this.#bU(a),
					(this.#cJ = a.name),
					(this.#cQ = Array.from(a.sentinelRootNodes)),
					(this.#cZ = a.maxCommandRediscovers ?? 16),
					(this.#cU = a.masterPoolSize ?? 1),
					(this.#cX = a.replicaPoolSize ?? 0),
					(this.#cM = a.scanInterval ?? 0),
					(this.#cN = a.passthroughClientErrorEvents ?? !1),
					(this.#cK = a.nodeClientOptions ? { ...a.nodeClientOptions } : {}),
					void 0 !== this.#cK.url)
				)
				...
				if (a.clientSideCache)
					if (a.clientSideCache instanceof o.PooledClientSideCacheProvider)
						this.#bI = this.#cK.clientSideCache = a.clientSideCache
					else {
						const b = a.clientSideCache
						this.#bI = this.#cK.clientSideCache = new o.BasicPooledClientSideCache(b)
					}
				if (
					((this.#cL = a.sentinelClientOptions ? Object.assign({}, a.sentinelClientOptions) : {}),
					(this.#cL.modules = m.default),
					void 0 !== this.#cL.url)
				)
					throw Error("invalid sentinelClientOptions for Sentinel")
				this.#cT = new n.WaitQueue()
				for (let a = 0; a < this.#cU; a++) this.#cT.push(a)
				this.#c$ = new k.PubSubProxy(this.#cK, (a) => this.emit("error", a))
			}
			#ch(a, b, c) {
			...
			getClientLease() {
				let a = this.#cT.shift()
				return void 0 !== a ? { id: a } : this.#cT.wait().then((a) => ({ id: a }))
			}
			releaseClientLease(a) {
				let b = this.#cS[a.id]
				if (void 0 !== b) {
					let c = b.resetIfDirty()
					if (c) return c.then(() => this.#cT.push(a.id))
				}
				this.#cT.push(a.id)
			}
			async connect() {
				if (this.#au) throw Error("already attempting to open")
				try {
					;(this.#au = !0), (this.#cY = this.#aB()), await this.#cY, (this.#av = !0)
				} finally {
					;(this.#cY = void 0), this.#cM > 0 && (this.#c_ = setInterval(this.#c0.bind(this), this.#cM))
				}
			}
			async #aB() {
				let a = 0
				for (;;) {
					if ((this.#cF("starting connect loop"), (a += 1), this.#ck))
						return void this.#cF("in #connect and want to destroy")
					try {
						if (((this.#cO = !1), await this.transform(this.analyze(await this.observe())), this.#cO)) {
							this.#cF("#connect: anotherReset is true, so continuing")
							continue
						}
						this.#cF("#connect: returning")
						return
					} catch (b) {
						if ((this.#cF(`#connect: exception ${b.message}`), !this.#av && a > this.#cZ)) throw b
						"no valid master node" !== b.message && console.log(b), await (0, l.setTimeout)(1e3)
					} finally {
						this.#cF("finished connect")
					}
				}
			}
			async execute(a, b) {
				...
				for (;;) {
					...
					this.#cF("attemping to send command to " + e?.host + ":" + e?.port)
					try {
						return await a(d)
					} catch (a) {
						if (++c > this.#cZ || !(a instanceof Error)) throw a
			...
			async #c3(a, b) {
				this.#cF("pubsub control channel message on " + a), this.#c0()
			}
			#c1(a) {
				if (void 0 !== a) return this.#cS[a.id]
				if ((this.#cW >= this.#cV.length && (this.#cW = 0), 0 == this.#cV.length))
					throw Error("no replicas available for read")
				return this.#cV[this.#cW++]
			}
			async #c0() {
				if (!1 != this.#av && !0 != this.#ck) {
					if (void 0 !== this.#cY) return (this.#cO = !0), await this.#cY
					try {
						return (this.#cY = this.#aB()), await this.#cY
					} finally {
						this.#cF("finished reconfgure"), (this.#cY = void 0)
					}
				}
			}
			async close() {
				;(this.#ck = !0),
					...
					(this.#av = !1),
					this.#bI?.onPoolClose(),
					this.#c_ && (clearInterval(this.#c_), (this.#c_ = void 0))
				let a = []
				for (let b of (void 0 !== this.#cR &&
					(this.#cR.isOpen && a.push(this.#cR.close()), (this.#cR = void 0)),
				this.#cS))
					b.isOpen && a.push(b.close())
				for (let b of ((this.#cS = []), this.#cV)) b.isOpen && a.push(b.close())
				;(this.#cV = []), await Promise.all(a), this.#c$.destroy(), (this.#au = !1)
			}
			async destroy() {
				for (let a of ((this.#ck = !0),
				void 0 != this.#cY && (await this.#cY),
				(this.#av = !1),
				this.#bI?.onPoolClose(),
				this.#c_ && (clearInterval(this.#c_), (this.#c_ = void 0)),
				void 0 !== this.#cR && (this.#cR.isOpen && this.#cR.destroy(), (this.#cR = void 0)),
				this.#cS))
					a.isOpen && a.destroy()
				for (let a of ((this.#cS = []), this.#cV)) a.isOpen && a.destroy()
				;(this.#cV = []), this.#c$.destroy(), (this.#au = !1), (this.#ck = !1)
			}
			async subscribe(a, b, c) {
			...
			async pSubscribe(a, b, c) {
				return this.#c$.pSubscribe(a, b, c)
			}
			async pUnsubscribe(a, b, c) {
				return this.#c$.pUnsubscribe(a, b, c)
			}
			async observe() {
				for (let a of this.#cQ) {
					let b
					try {
						this.#cF(`observe: trying to connect to sentinel: ${a.host}:${a.port}`),
							(b = this.#ch(a, this.#cL, !1)).on("error", (a) =>
								this.emit("error", `obseve client error: ${a}`),
							),
							await b.connect(),
							this.#cF("observe: connected to sentinel")
						let [c, d, e] = await Promise.all([
							b.sentinel.sentinelSentinels(this.#cJ),
							b.sentinel.sentinelMaster(this.#cJ),
							b.sentinel.sentinelReplicas(this.#cJ),
						])
						return (
							this.#cF("observe: got all sentinel data"),
							{
								sentinelConnected: a,
								sentinelData: c,
								masterData: d,
								...
								replicaPoolSize: this.#cX,
								useReplicas: this.useReplicas,
							}
						)
					} catch (a) {
						this.#cF(`observe: error ${a}`), this.emit("error", a)
					} finally {
						void 0 !== b && b.isOpen && (this.#cF("observe: destroying sentinel client"), b.destroy())
					}
				}
				throw (
					(this.#cF("observe: none of the sentinels are available"),
			...
			analyze(a) {
				...
				if (void 0 === b)
					throw (
						(this.#cF(`analyze: no valid master node because ${a.masterData.flags}`),
				...
				c.host === a.currentSentinel?.host && c.port === a.currentSentinel.port
					? (this.#cF("analyze: sentinel node hasn't changed"), (c = void 0))
					: this.#cF(`analyze: sentinel node has changed to ${c.host}:${c.port}`)
				let d = [],
					e = new Map(),
					f = new Set(),
					g = new Set()
						...
						f.has(JSON.stringify(b))
							? (g.add(JSON.stringify(b)),
								c != a.replicaPoolSize &&
									...
									this.#cF(`analyze: adding ${b.host}:${b.port} to replicsToOpen`)))
							: (d.push(b), this.#cF(`analyze: adding ${b.host}:${b.port} to replicsToClose`))
					for (let c of b)
						g.has(JSON.stringify(c)) ||
							(e.set(c, a.replicaPoolSize),
							this.#cF(`analyze: adding ${c.host}:${c.port} to replicsToOpen`))
				}
				return {
			...
			async transform(a) {
				this.#cF("transform: enter")
				let b = []
				if (a.sentinelToOpen) {
					this.#cF("transform: opening a new sentinel"),
						void 0 !== this.#cR && this.#cR.isOpen
							? (this.#cF("transform: destroying old sentinel as open"),
								this.#cR.destroy(),
								(this.#cR = void 0))
							: this.#cF("transform: not destroying old sentinel as not open"),
						this.#cF(
							`transform: creating new sentinel to ${a.sentinelToOpen.host}:${a.sentinelToOpen.port}`,
						)
					let c = a.sentinelToOpen,
						d = this.#ch(a.sentinelToOpen, this.#cL, !1)
					d.on("error", (a) => {
						this.#cN &&
							this.emit(
								"error",
						...
						this.emit("client-error", b), this.#c0()
					}),
						(this.#cR = d),
						this.#cF("transform: adding sentinel client connect() to promise list")
					let e = this.#cR.connect().then((a) => this.#c2(a))
					b.push(e), this.#cF(`created sentinel client to ${a.sentinelToOpen.host}:${a.sentinelToOpen.port}`)
					let f = { type: "SENTINEL_CHANGE", node: a.sentinelToOpen }
					this.#cF("transform: emiting topology-change event for sentinel_change"),
						this.emit("topology-change", f) ||
							this.#cF("transform: emit for topology-change for sentinel_change returned false")
				}
				if (a.masterToOpen) {
					this.#cF("transform: opening a new master")
					let c = [],
						d = []
					for (let a of (this.#cF("transform: destroying old masters if open"), this.#cS))
						d.push(a.isWatching || a.isDirtyWatch), a.isOpen && a.destroy()
					;(this.#cS = []), this.#cF("transform: creating all master clients and adding connect promises")
					for (let b = 0; b < this.#cU; b++) {
						let e = a.masterToOpen,
							f = this.#ch(a.masterToOpen, this.#cK)
						f.on("error", (a) => {
							this.#cN &&
								this.emit(
									"error",
							...
							this.#cS.push(f),
							c.push(f.connect()),
							this.#cF(`created master client to ${a.masterToOpen.host}:${a.masterToOpen.port}`)
					}
					this.#cF("transform: adding promise to change #pubSubProxy node"),
						c.push(this.#c$.changeNode(a.masterToOpen)),
						b.push(...c)
					let e = { type: "MASTER_CHANGE", node: a.masterToOpen }
					this.#cF("transform: emiting topology-change event for master_change"),
						this.emit("topology-change", e) ||
							this.#cF("transform: emit for topology-change for master_change returned false"),
						this.#cP++
				}
				let c = new Set()
				...
				let d = [],
					e = new Set()
				for (let a of this.#cV) {
					let b = (0, i.clientSocketToNode)(a.options.socket),
						f = JSON.stringify(b)
					if (c.has(f) || !a.isOpen) {
						if (a.isOpen) {
							let b = a.options?.socket
							this.#cF(`destroying replica client to ${b?.host}:${b?.port}`), a.destroy()
						}
						if (!e.has(f)) {
				...
				if (((this.#cV = d), 0 != a.replicasToOpen.size))
					for (let [c, d] of a.replicasToOpen) {
						for (let a = 0; a < d; a++) {
							let a = this.#ch(c, this.#cK)
							a.on("error", (b) => {
								this.#cN &&
									this.emit(
										"error",
								...
								this.#cV.push(a),
								b.push(a.connect()),
								this.#cF(`created replica client to ${c.host}:${c.port}`)
						}
						let a = { type: "REPLICA_ADD", node: c }
						this.emit("topology-change", a)
					}
				if (a.sentinelList.length != this.#cQ.length) {
					this.#cQ = a.sentinelList
					let b = { type: "SENTINE_LIST_CHANGE", size: a.sentinelList.length }
					this.emit("topology-change", b)
				}
				await Promise.all(b), this.#cF("transform: exit")
			}
			getMasterNode() {
				if (0 != this.#cS.length) {
					for (let a of this.#cS) if (a.isReady) return (0, i.clientSocketToNode)(a.options.socket)
				}
			}
			getSentinelNode() {
				if (void 0 !== this.#cR) return (0, i.clientSocketToNode)(this.#cR.options.socket)
			}
			getReplicaNodes() {
				let a = new Map(),
					b = new Map()
		...
		class s extends e.EventEmitter {
			...
			#c4 = -1
			constructor(a) {
				super(), (this.options = a), (this.#cQ = a.sentinelRootNodes)
			}
			async updateSentinelRootNodes() {
				for (let a of this.#cQ) {
					...
					try {
						...
						this.#cQ = [a].concat((0, i.createNodeList)(c))
						return
					} finally {
						b.destroy()
					}
  ...
  `)
	...
	(a, b, c) => {
		...
		let d = a.r(23185),
			...
			f = a.r(11349)
		class g {
			static #c5 = (this.EMPTY = new g(null, { metadata: {}, contentType: null }))
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c215df51._.js.map

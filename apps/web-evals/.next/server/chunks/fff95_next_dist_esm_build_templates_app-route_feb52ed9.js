module.exports = [
	...
	(A) => {
		...
		function E() {
			return new c.NextResponse(Q, {
				headers: { "Content-Type": "image/x-icon", "Cache-Control": "public, max-age=0, must-revalidate" },
			})
		}
		A.s(["GET", () => E, "dynamic", 0, "force-static"], 70266)
		var d = A.i(70266)
		let M = new w.AppRouteRouteModule({
				definition: {
					kind: D.RouteKind.APP_ROUTE,
				...
				distDir: ".next",
				relativeProjectDir: "",
				resolvedPagePath: "[project]/apps/web-evals/src/app/favicon--route-entry.js",
				nextConfigOutput: "",
				userland: d,
			}),
			{ workAsyncStorage: G, workUnitAsyncStorage: f, serverHooks: p } = M
		function R() {
			return (0, P.patchFetch)({ workAsyncStorage: G, workUnitAsyncStorage: f })
		}
		async function v(A, w, P) {
			M.isDev && (0, e.addRequestMeta)(A, "devRequestTimingInternalsEnd", process.hrtime.bigint())
			let c = "/favicon.ico/route"
			c = c.replace(/\/index$/, "") || "/"
			let Q = await M.prepare(A, w, { srcPage: c, multiZoneDraftMode: !1 })
			if (!Q)
				return (
					(w.statusCode = 400),
					w.end("Bad Request"),
			...
			let {
				...
				T = (0, g.normalizeAppPath)(c),
				j = !!(R.dynamicRoutes[T] || R.routes[y]),
				V = async () => (
					(null == v ? void 0 : v.render404)
						? await v.render404(A, w, f, !1)
						: w.end("This page could not be found"),
					null
				)
			if (j && !p) {
				let A = !!R.routes[y],
					w = R.dynamicRoutes[T]
				if (w && !1 === w.fallback && !A) {
					if (G.experimental.adapterPath) return await V()
					throw new C.NoFallbackError()
				}
			}
			let J = null
			!j || M.isDev || p || (J = "/index" === (J = y) ? "/" : J)
			let L = !0 === M.isDev || !j,
				N = j && !L
			Y && O && (0, r.setManifestsSingleton)({ page: c, clientReferenceManifest: O, serverActionsManifest: Y })
			let S = A.method || "GET",
				b = (0, t.getTracer)(),
				X = b.getActiveScopeSpan(),
				F = {
					params: d,
					prerenderManifest: R,
					renderOpts: {
						...
						incrementalCache: (0, e.getRequestMeta)(A, "incrementalCache"),
						...
						onInstrumentationRequestError: (w, D, P, e) => M.onRequestError(A, w, P, e, v),
					},
					sharedContext: { buildId: E },
				},
				x = new n.NodeNextRequest(A),
				K = new n.NodeNextResponse(w),
				k = o.NextRequestAdapter.fromNodeNextRequest(x, (0, o.signalFromNodeResponse)(w))
			try {
				let r = async (A) =>
						M.handle(k, F).finally(() => {
							if (!A) return
							A.setAttributes({ "http.status_code": w.statusCode, "next.rsc": !1 })
							let D = b.getRootSpanAttributes()
							if (!D) return
							if (D.get("next.span_type") !== a.BaseServerSpan.handleRequest)
								return void console.warn(
									`Unexpected root span type '${D.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`,
								)
							let P = D.get("next.route")
							if (P) {
								let w = `${S} ${P}`
								A.setAttributes({ "next.route": P, "http.route": P, "next.span_name": w }),
									A.updateName(w)
							} else A.updateName(`${S} ${c}`)
						}),
					g = !!(0, e.getRequestMeta)(A, "minimalMode"),
					n = async (e) => {
						var t, n
						let o = async ({ previousCacheEntry: D }) => {
								try {
									if (!g && H && h && !D)
										return (
											(w.statusCode = 404),
											w.setHeader("x-nextjs-cache", "REVALIDATED"),
											w.end("This page could not be found"),
											null
										)
									let t = await r(e)
									A.fetchMetrics = F.renderOpts.fetchMetrics
									let n = F.renderOpts.pendingWaitUntil
									n && P.waitUntil && (P.waitUntil(n), (n = void 0))
									let o = F.renderOpts.collectedTags
									if (!j)
										return await (0, B.sendResponse)(x, K, t, F.renderOpts.pendingWaitUntil), null
									{
										let A = await t.blob(),
											w = (0, s.toNodeOutgoingHttpHeaders)(t.headers)
										o && (w[u.NEXT_CACHE_TAGS_HEADER] = o),
											!w["content-type"] && A.type && (w["content-type"] = A.type)
										let D =
												void 0 !== F.renderOpts.collectedRevalidate &&
												!(F.renderOpts.collectedRevalidate >= u.INFINITE_CACHE) &&
												F.renderOpts.collectedRevalidate,
											P =
												void 0 === F.renderOpts.collectedExpire ||
												F.renderOpts.collectedExpire >= u.INFINITE_CACHE
													? void 0
										...
										return {
											...
											cacheControl: { revalidate: D, expire: P },
										}
									}
								} catch (w) {
									throw (
										((null == D ? void 0 : D.isStale) &&
											(await M.onRequestError(
												...
												w,
												{
													...
													routePath: c,
													routeType: "route",
													revalidateReason: (0, i.getRevalidateReason)({
							...
							a = await M.handleResponse({
								req: A,
								nextConfig: G,
								cacheKey: J,
								routeKind: D.RouteKind.APP_ROUTE,
								isFallback: !1,
								prerenderManifest: R,
								isRoutePPREnabled: !1,
								isOnDemandRevalidate: H,
						...
						if (!j) return null
						if ((null == a || null == (t = a.value) ? void 0 : t.kind) !== I.CachedRouteKind.APP_ROUTE)
							throw Object.defineProperty(
								Error(
									`Invariant: app-route received invalid cache entry ${null == a || null == (n = a.value) ? void 0 : n.kind}`,
								),
								"__NEXT_ERROR_CODE",
						...
						g ||
							w.setHeader(
								"x-nextjs-cache",
								H ? "REVALIDATED" : a.isMiss ? "MISS" : a.isStale ? "STALE" : "HIT",
							),
							p && w.setHeader("Cache-Control", "private, no-cache, no-store, max-age=0, must-revalidate")
						let C = (0, s.fromNodeOutgoingHttpHeaders)(a.value.headers)
						return (
							(g && j) || C.delete(u.NEXT_CACHE_TAGS_HEADER),
							!a.cacheControl ||
								w.getHeader("Cache-Control") ||
								C.get("Cache-Control") ||
								C.set("Cache-Control", (0, l.getCacheControlHeader)(a.cacheControl)),
							await (0, B.sendResponse)(
								x,
								K,
								new Response(a.value.body, { headers: C, status: a.value.status || 200 }),
							),
							null
						)
					}
				X
					? await n(X)
					: await b.withPropagatedContext(A.headers, () =>
							b.trace(
								a.BaseServerSpan.handleRequest,
								{
									spanName: `${S} ${c}`,
									kind: t.SpanKind.SERVER,
									attributes: { "http.method": S, "http.target": A.url },
								},
								n,
							),
						)
				...
				if (
					(w instanceof C.NoFallbackError ||
						(await M.onRequestError(
							A,
							w,
							{
					...
					throw w
				return await (0, B.sendResponse)(x, K, new Response(null, { status: 500 })), null
			}
		}
		A.s(
			[
...
//# sourceMappingURL=fff95_next_dist_esm_build_templates_app-route_feb52ed9.js.map

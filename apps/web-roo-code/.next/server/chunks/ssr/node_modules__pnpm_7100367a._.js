module.exports = [
	...
	(a) => {
		...
		var c,
			...
			w = (function (a) {
				...
				return function (a) {
					...
					if (0 === e.major) return e.minor === g.minor && e.patch <= g.patch ? (b.add(a), !0) : f(a)
		...
		function y(a, b, c, d) {
			...
			return (f[a] = b), c.debug("@opentelemetry/api: Registered a global for " + a + " v" + u + "."), !0
		}
		function z(a) {
			var b,
				c,
		...
		function A(a, b) {
			b.debug("@opentelemetry/api: Unregistering a global for " + a + " v" + u + ".")
			var c = t[x]
			c && delete c[a]
		}
		var B = function (a, b) {
		...
		var F = function (a, b) {
			...
			M = (function () {
				...
				return (
					...
					(a.prototype.with = function (a, b, c) {
						...
						return (d = this._getContextManager()).with.apply(d, J([a, b, c], I(e), !1))
					}),
					(a.prototype.bind = function (a, b) {
			...
			P =
				...
				function (a, b) {
					...
					j(a, b), (a.prototype = null === b ? Object.create(b) : ((c.prototype = b.prototype), new c()))
				}),
			Q = (function () {
				function a() {}
				return (
			...
			W = (function () {
				function a() {}
				return (a.prototype.addCallback = function (a) {}), (a.prototype.removeCallback = function (a) {}), a
			})(),
			X = (function (a) {
				function b() {
					return (null !== a && a.apply(this, arguments)) || this
		...
		function ay(a) {
			return (
				"string" != typeof a &&
					(aw.error("Cannot create baggage metadata from unknown type: " + typeof a), (a = "")),
				{
					__TYPE__: av,
					toString: function () {
						return a
			...
			aB = (function () {
				...
				return (
					...
					(a.prototype.inject = function (a, b, c) {
						return void 0 === c && (c = am), this._getGlobalPropagator().inject(a, b, c)
					}),
					(a.prototype.extract = function (a, b, c) {
						return void 0 === c && (c = al), this._getGlobalPropagator().extract(a, b, c)
					}),
					(a.prototype.fields = function () {
		...
		;((k = d || (d = {}))[(k.NONE = 0)] = "NONE"), (k[(k.SAMPLED = 1)] = "SAMPLED")
		...
		var aT = M.getInstance(),
			aU = (function () {
				...
				return (
					(a.prototype.startSpan = function (a, b, c) {
						if ((void 0 === c && (c = aT.active()), null == b ? void 0 : b.root)) return new aF()
						var d,
							e = c && aM(c)
			...
			aY = (function () {
				...
				return (
					(a.prototype.getTracer = function (a, b, c) {
						var d
						return null != (d = this.getDelegateTracer(a, b, c)) ? d : new aW(this, a, b, c)
					}),
		...
		;((l = e || (e = {}))[(l.INT = 0)] = "INT"),
			...
			(o[(o.ERROR = 2)] = "ERROR")
		var a2 = "[_0-9a-z-*/]",
			a3 = RegExp("^(?:[a-z]" + a2 + "{0,255}|" + ("[a-z0-9]" + a2 + "{0,240}@[a-z]") + a2 + "{0,13})$"),
			a4 = /^[ -~]{0,255}[!-~]$/,
			a5 = /,|=/,
			a6 = (function () {
				function a(a) {
					...
					325: (a, b, c) => {
						...
						class e {
							...
							set(a, b) {
								let c = this._clone()
								return (
									c._internalState.has(a) && c._internalState.delete(a), c._internalState.set(a, b), c
								)
							}
							unset(a) {
								let b = this._clone()
		...
		var n = ["strict", "lax", "none"],
			...
			q = class {
				constructor(a) {
					...
					const e =
						null !=
						(d = null != (c = null == (b = a.getSetCookie) ? void 0 : b.call(a)) ? c : a.get("set-cookie"))
							? d
							: []
	...
	(a) => {
		...
		a.i(8237), Symbol("internal request"), Request, Symbol.for("edge-runtime.inspect.custom")
...
//# sourceMappingURL=node_modules__pnpm_7100367a._.js.map

module.exports = [
	...
	(a) => {
		...
		function d() {}
		function e() {}
		let f = /^[$_\p{ID_Start}][$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,
			g = /^[$_\p{ID_Start}][-$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,
			h = {}
		function i(a, b) {
			return ((b || h).jsx ? g : f).test(a)
		}
		let j = /[ \t\n\f\r]/g
		function k(a) {
			return "" === a.replace(j, "")
		...
		function H(a) {
			...
			for (let [d, e] of Object.entries(a.properties)) {
				let f = new x(d, a.transform(a.attributes || {}, d), e, a.space)
				a.mustUseProperty && a.mustUseProperty.includes(d) && (f.mustUseProperty = !0),
					(b[d] = f),
					(c[y(d)] = d),
					(c[y(f.attribute)] = d)
			}
			return new F(b, c, a.space)
		}
		...
		function X(a) {
			return Z(a && a.line) + ":" + Z(a && a.column)
		}
		function Y(a) {
			return X(a && a.start) + "-" + X(a && a.end)
		}
		function Z(a) {
		...
		let _ = {}.hasOwnProperty,
			aa = new Map(),
			ab = /[A-Z]/g,
			ac = new Set(["table", "tbody", "thead", "tfoot", "tr"]),
			ad = new Set(["td", "th"]),
			ae = "https://github.com/syntax-tree/hast-util-to-jsx-runtime"
		function af(a, b, c) {
			var e, f, g, h, i, j, m, n, o
			let p, q, r, s, t, u, v, w, F, G, H
			return "element" === b.type
				? ((e = a),
					(f = b),
					(g = c),
					(q = p = e.schema),
					"svg" === f.tagName.toLowerCase() && "html" === p.space && (e.schema = R),
					e.ancestors.push(f),
					(r = aj(e, f.tagName, !1)),
					(s = (function (a, b) {
						let c,
						...
						for (d in b.properties)
							if ("children" !== d && _.call(b.properties, d)) {
								let f = (function (a, b, c) {
									let d = (function (a, b) {
										...
										if (c.length > 4 && "data" === c.slice(0, 4) && B.test(b)) {
											if ("-" === b.charAt(4)) {
												let a = b.slice(5).replace(A, D)
										...
										if (
											...
											let b =
												"object" == typeof c
													...
													: (function (a, b) {
															try {
																return (0, S.default)(b, { reactCompat: !0 })
															} catch (c) {
																if (a.ignoreInvalidStyle) return {}
																let b = new $("Cannot parse `style` attribute", {
																...
																throw (
																	...
																	(b.url = ae + "#cannot-parse-style-attribute"),
																	b)
																)
															}
														})(a, String(c))
					...
					ac.has(f.tagName) &&
						(t = t.filter(function (a) {
							return (
								"string" != typeof a || !("object" == typeof a ? "text" === a.type && k(a.value) : k(a))
							)
						})),
					ag(e, s, r, f),
					ah(s, t),
				...
				: "mdxFlowExpression" === b.type || "mdxTextExpression" === b.type
					? (function (a, b) {
							if (b.data && b.data.estree && a.evaluater) {
								...
								return d("ExpressionStatement" === c.type), a.evaluater.evaluateExpression(c.expression)
							}
							ak(a, b.position)
						})(a, b)
					: "mdxJsxFlowElement" === b.type || "mdxJsxTextElement" === b.type
						? ((h = a),
							...
							(j = c),
							(v = u = h.schema),
							"svg" === i.name && "html" === u.space && (h.schema = R),
							h.ancestors.push(i),
							(w = null === i.name ? h.Fragment : aj(h, i.name, !0)),
							(F = (function (a, b) {
								let c = {}
								for (let e of b.attributes)
									if ("mdxJsxExpressionAttribute" === e.type)
										if (e.data && e.data.estree && a.evaluater) {
											...
											d("ExpressionStatement" === b.type)
											let f = b.expression
											d("ObjectExpression" === f.type)
											let g = f.properties[0]
											d("SpreadElement" === g.type),
												Object.assign(c, a.evaluater.evaluateExpression(g.argument))
										} else ak(a, b.position)
									else {
										let f,
											g = e.name
						...
						: "mdxjsEsm" === b.type
							...
							: "root" === b.type
								? ((m = a), (n = b), (o = c), ah((H = {}), ai(m, n)), m.create(n, m.Fragment, H, o))
								: "text" === b.type
									? b.value
									: void 0
		}
			...
			if (c)
				if (b.includes(".")) {
					let a,
						...
						f = -1
					for (; ++f < c.length; ) {
						let b = i(c[f]) ? { type: "Identifier", name: c[f] } : { type: "Literal", value: c[f] }
						a = a
							? {
					...
					d(a, "always a result"), (e = a)
				} else e = i(b) && !/^[a-z]/.test(b) ? { type: "Identifier", name: b } : { type: "Literal", value: b }
			else e = { type: "Literal", value: b }
			if ("Literal" === e.type) {
				let b = e.value
				return _.call(a.components, b) ? a.components[b] : b
			}
			if (a.evaluater) return a.evaluater.evaluateExpression(e)
			ak(a)
		}
		function ak(a, b) {
			let c = new $("Cannot handle MDX estrees without `createEvaluater`", {
				ancestors: a.ancestors,
				place: b,
				ruleId: "mdx-estree",
				source: "hast-util-to-jsx-runtime",
			...
			throw (
				...
				(c.url = ae + "#cannot-handle-mdx-estrees-without-createevaluater"),
				c)
			)
		}
		function al(a) {
		...
		function ap(a, b, c) {
			...
			if ((d = a) && "object" == typeof d) {
				...
				if ("children" in a) return aq(a.children, b, c)
			}
			return Array.isArray(a) ? aq(a, b, c) : ""
		}
		function aq(a, b, c) {
			let d = [],
				e = -1
			for (; ++e < a.length; ) d[e] = ap(a[e], b, c)
			return d.join("")
		}
		function ar(a, b, c, d) {
			let e,
		...
		function as(a, b) {
			return a.length > 0 ? (ar(a, a.length, 0, b), a) : b
		}
		...
		function aI(a, b, c, d) {
			...
			return function (d) {
				return aE(d)
					? (a.enter(c),
						(function d(g) {
							return aE(g) && f++ < e ? (a.consume(g), d) : (a.exit(c), b(g))
						})(d))
					: b(d)
			}
		}
		let aJ = {
				...
				tokenize: function (a) {
					...
					function i(a) {
						if ((g++, e.containerState._closeFlow)) {
							...
							return ar(e.events, f + 1, 0, e.events.slice(d)), (e.events.length = h), j(a)
						}
						return h(a)
					}
					function j(c) {
						...
						return (e.containerState = {}), a.check(aL, k, l)(c)
					}
					function k(a) {
						return b && r(), q(g), m(a)
					}
					...
					function m(b) {
						return (e.containerState = {}), a.attempt(aL, n, o)(b)
					}
					function n(a) {
					...
					function p(a, f) {
						...
						if (
							...
							ar(e.events, i + 1, 0, e.events.slice(h)), (e.events.length = f)
						}
					}
					function q(b) {
						let c = f.length
			...
			aM = {
				...
				tokenize: function (a, b, c) {
					return function (b) {
						return aE(b) ? aI(a, d, "linePrefix")(b) : d(b)
					}
					function d(a) {
						return null === a || aC(a) ? b(a) : c(a)
					}
				},
			}
		class aN {
			...
			splice(a, b, c) {
				...
				return c && aO(this.left, c), d.reverse()
			}
			pop() {
			...
			pushMany(a) {
				this.setCursor(1 / 0), aO(this.left, a)
			}
			unshift(a) {
				this.setCursor(0), this.right.push(a)
			}
			unshiftMany(a) {
				this.setCursor(0), aO(this.right, a.reverse())
			}
			setCursor(a) {
				if (
					a !== this.left.length &&
		...
		let aQ = {
				...
				tokenize: function (a, b) {
					...
					function d(b) {
						return null === b ? e(b) : aC(b) ? a.check(aR, f, e)(b) : (a.consume(b), d)
					}
					function e(c) {
					...
					let b = this,
						c = a.attempt(
							...
							a.attempt(
								...
								d,
								aI(a, a.attempt(this.parser.constructs.flow, d, a.attempt(aQ, d)), "linePrefix"),
							),
						)
					return c
					function d(d) {
		...
		function aW(a) {
			return {
				resolveAll: aX("text" === a ? aY : void 0),
				tokenize: function (b) {
					let c = this,
		...
		function aZ(a) {
			return null === a || aD(a) || aG(a) ? 1 : aF(a) ? 2 : void 0
		}
		function a$(a, b, c) {
			let d = [],
				e = -1
						...
						for (c = k; c--; )
							if (
								...
								a0(l, -h),
									...
									(i = as(i, a$(b.parser.constructs.insideSpan.null, a.slice(c + 1, k), b))),
									(i = as(i, [
										["exit", e, b],
										["enter", g, b],
										["exit", g, b],
		...
		let a6 = {
					...
					function h(b) {
						return 35 === b
							? (a.enter("characterReferenceMarkerNumeric"),
								...
								i)
							: (a.enter("characterReferenceValue"), (d = 31), (e = aw), j(b))
					}
					function i(b) {
						return 88 === b || 120 === b
							? (a.enter("characterReferenceMarkerHexadecimal"),
								...
								(e = aA),
								j)
							: (a.enter("characterReferenceValue"), (d = 7), (e = az), j(b))
					}
					function j(h) {
						if (59 === h && g) {
							let d = a.exit("characterReferenceValue")
							return e !== aw || a5(f.sliceSerialize(d))
								? (a.enter("characterReferenceMarker"),
									a.consume(h),
									a.exit("characterReferenceMarker"),
			...
			a8 = {
				...
				tokenize: function (a, b, c) {
												...
												return e === d
													...
													: f >= h
														? (a.exit("codeFencedFenceSequence"),
															aE(e) ? aI(a, j, "whitespace")(e) : j(e))
														: c(e)
											})(b))
										: c(b)
								}
								function j(d) {
									return null === d || aC(d) ? (a.exit("codeFencedFence"), b(d)) : c(d)
								}
							},
						},
						g = 0,
						...
						return (
							...
							(function b(e) {
								return e === d
									...
									: h < 3
										? c(e)
										: (a.exit("codeFencedFenceSequence"), aE(e) ? aI(a, i, "whitespace")(e) : i(e))
							})(f)
						)
					}
					function i(f) {
						return null === f || aC(f)
							? (a.exit("codeFencedFence"), e.interrupt ? b(f) : a.check(a7, k, o)(f))
					...
					function m(b) {
						return g > 0 && aE(b) ? aI(a, n, "linePrefix", g + 1)(b) : n(b)
					}
					function n(b) {
						return null === b || aC(b)
							? a.check(a7, k, o)(b)
							: (a.enter("codeFlowValue"),
								(function b(c) {
									return null === c || aC(c) ? (a.exit("codeFlowValue"), n(c)) : (a.consume(c), b)
								})(b))
					}
					function o(c) {
			...
			a9 = {
				...
				tokenize: function (a, b, c) {
					let d = this
					return function (b) {
						return a.enter("codeIndented"), aI(a, e, "linePrefix", 5)(b)
					}
					function e(b) {
		...
		function bc(a, b, c, d, e, f) {
			...
			function k(b) {
				return null === b || 91 === b || 93 === b || aC(b) || i++ > 999
					? (a.exit("chunkString"), j(b))
					: (a.consume(b), g || (g = !aE(b)), 92 === b ? l : k)
			}
			function l(b) {
			...
			function i(b) {
				return b === g
					...
					: null === b
						? c(b)
						: aC(b)
							? (a.enter("lineEnding"), a.consume(b), a.exit("lineEnding"), aI(a, i, "linePrefix"))
							: (a.enter("chunkString", { contentType: "string" }), j(b))
			}
			function j(b) {
				return b === g || null === b || aC(b) ? (a.exit("chunkString"), i(b)) : (a.consume(b), 92 === b ? k : j)
			}
			function k(b) {
		...
		function be(a, b) {
			...
			return function d(e) {
				return aC(e)
					...
					: aE(e)
						? aI(a, d, c ? "linePrefix" : "lineSuffix")(e)
						: b(e)
			}
		}
		function bf(a) {
		...
		let bg = {
				...
				tokenize: function (a, b, c) {
					return function (b) {
						return aD(b) ? be(a, d)(b) : c(b)
					}
					function d(b) {
						return bd(a, e, c, "definitionTitle", "definitionTitleMarker", "definitionTitleString")(b)
					}
					function e(b) {
						return aE(b) ? aI(a, f, "whitespace")(b) : f(b)
					}
					function f(a) {
						return null === a || aC(a) ? b(a) : c(a)
					}
			...
			bi = ["pre", "script", "style", "textarea"],
			bj = {
				partial: !0,
				tokenize: function (a, b, c) {
					return function (d) {
						return a.enter("lineEnding"), a.consume(d), a.exit("lineEnding"), a.attempt(aM, b, c)
					}
				},
			},
			bk = {
				...
				tokenize: function (a, b, c) {
					let d = this
					return function (b) {
						return aC(b) ? (a.enter("lineEnding"), a.consume(b), a.exit("lineEnding"), e) : c(b)
					}
					function e(a) {
						return d.parser.lazy[d.now().line] ? c(a) : b(a)
					}
			...
			bl = {
				...
				resolveAll: function (a) {
					...
					return a.length !== c.length && ar(a, 0, a.length, c), a
				},
				resolveTo: function (a, b) {
					...
					return (
						...
						(f = as(f, [["enter", k, b]])),
						(f = as(f, a$(b.parser.constructs.insideSpan.null, a.slice(d + h + 4, e - 3), b))),
						(f = as(f, [["exit", k, b], a[e - 2], a[e - 1], ["exit", j, b]])),
						(f = as(f, a.slice(e + 1))),
						(f = as(f, [["exit", i, b]])),
						ar(a, d, a.length, f),
						a
				...
				tokenize: function (a, b, c) {
						...
						return d
							? d._inactive
								...
								: ((e = f.parser.defined.includes(
										bf(f.sliceSerialize({ start: d.end, end: f.now() })),
									)),
									a.enter("labelEnd"),
									a.enter("labelMarker"),
									a.consume(b),
					...
					function h(b) {
						return 40 === b
							? a.attempt(bm, j, e ? j : k)(b)
							: 91 === b
								? a.attempt(bn, j, e ? i : k)(b)
								: e
									? j(b)
									: k(b)
					}
					function i(b) {
						return a.attempt(bo, j, k)(b)
					}
					function j(a) {
						return b(a)
					}
			...
			bm = {
				tokenize: function (a, b, c) {
					...
					function h(b) {
						return 34 === b || 39 === b || 40 === b
							? bd(a, i, c, "resourceTitle", "resourceTitleMarker", "resourceTitleString")(b)
							: j(b)
					}
					function i(b) {
						return aD(b) ? be(a, j)(b) : j(b)
					}
					function j(d) {
						return 41 === d
			...
			bn = {
				tokenize: function (a, b, c) {
					let d = this
					return function (b) {
						return bc.call(d, a, e, f, "reference", "referenceMarker", "referenceString")(b)
					}
					function e(a) {
						return d.parser.defined.includes(
							bf(d.sliceSerialize(d.events[d.events.length - 1][1]).slice(1, -1)),
						)
							? b(a)
							: c(a)
					}
			...
			br = {
				...
				tokenize: function (a, b) {
					return function (c) {
						return a.enter("lineEnding"), a.consume(c), a.exit("lineEnding"), aI(a, b, "linePrefix")
					}
				},
			},
			bs = {
			...
			bt = {
							...
							a.check(
								...
								function (c) {
									return (
										...
										aI(a, b, "listItemIndent", d.containerState.size + 1)(c)
									)
								},
								function (c) {
									return d.containerState.furtherBlankLines || !aE(c)
				...
				tokenize: function (a, b, c) {
					...
					return function (b) {
						...
						if ("listUnordered" === e ? !d.containerState.marker || b === d.containerState.marker : az(b)) {
							if (
								(d.containerState.type || ((d.containerState.type = e), a.enter(e, { _container: !0 })),
								"listUnordered" === e)
							)
								return a.enter("listItemPrefix"), 42 === b || 45 === b ? a.check(bs, c, h)(b) : h(b)
							if (!d.interrupt || 49 === b)
								return (
					...
					function h(b) {
						return (
							...
							a.check(aM, d.interrupt ? c : i, a.attempt(bu, k, j))
						)
					}
					function i(a) {
			...
			bu = {
				...
				tokenize: function (a, b, c) {
					...
					return aI(
						...
						function (a) {
							let e = d.events[d.events.length - 1]
							return !aE(a) && e && "listItemPrefixWhitespace" === e[1].type ? b(a) : c(a)
						},
								...
								(function b(c) {
									return c === d
										...
										: (a.exit("setextHeadingLineSequence"),
											aE(c) ? aI(a, f, "lineSuffix")(c) : f(c))
								})(g))
							: c(b)
					}
					function f(d) {
						return null === d || aC(d) ? (a.exit("setextHeadingLine"), b(d)) : c(d)
					}
				},
			}
		a.s(
				...
				0,
				{
					91: {
						...
						tokenize: function (a, b, c) {
							...
							function f(b) {
								return ((d = bf(e.sliceSerialize(e.events[e.events.length - 1][1]).slice(1, -1))),
								58 === b)
									? (a.enter("definitionMarker"), a.consume(b), a.exit("definitionMarker"), g)
									: c(b)
							}
							function g(b) {
								return aD(b) ? be(a, h)(b) : h(b)
							}
							function h(b) {
								return bb(
									a,
							...
							function i(b) {
								return a.attempt(bg, j, j)(b)
							}
							function j(b) {
								return aE(b) ? aI(a, k, "whitespace")(b) : k(b)
							}
							function k(f) {
								return null === f || aC(f)
				...
				0,
				{
					...
					60: {
						...
						tokenize: function (a, b, c) {
							...
							function n(b) {
								return av(b) ? (a.consume(b), (f = String.fromCharCode(b)), o) : c(b)
							}
							function o(g) {
								if (null === g || 47 === g || 62 === g || aD(g)) {
									let h = 47 === g,
										j = f.toLowerCase()
									return !h && !e && bi.includes(j)
										? ((d = 1), i.interrupt ? b(g) : y(g))
										: bh.includes(f.toLowerCase())
											? ((d = 6), h)
												? (a.consume(g), p)
												: i.interrupt
													? b(g)
											...
											: ((d = 7),
												i.interrupt && !i.parser.lazy[i.now().line]
													...
													: e
														? (function b(c) {
																return aE(c) ? (a.consume(c), b) : w(c)
															})(g)
														: q(g))
								}
								return 45 === g || aw(g) ? (a.consume(g), (f += String.fromCharCode(g)), o) : c(g)
							}
							function p(d) {
							...
							function r(b) {
								return 45 === b || 46 === b || 58 === b || 95 === b || aw(b) ? (a.consume(b), r) : s(b)
							}
							function s(b) {
								return 61 === b ? (a.consume(b), t) : aE(b) ? (a.consume(b), s) : q(b)
							}
							function t(b) {
							...
							function v(a) {
								return 47 === a || 62 === a || aE(a) ? q(a) : c(a)
							}
							function w(b) {
								return 62 === b ? (a.consume(b), x) : c(b)
							}
							function x(b) {
								return null === b || aC(b) ? y(b) : aE(b) ? (a.consume(b), x) : c(b)
							}
							function y(b) {
								return 45 === b && 2 === d
									? (a.consume(b), C)
										...
										: 62 === b && 4 === d
											...
											: 63 === b && 3 === d
												...
												: 93 === b && 5 === d
													? (a.consume(b), F)
													: aC(b) && (6 === d || 7 === d)
														? (a.exit("htmlFlowData"), a.check(bj, I, z)(b))
														: null === b || aC(b)
															? (a.exit("htmlFlowData"), z(b))
															: (a.consume(b), y)
							}
							function z(b) {
								return a.check(bk, A, I)(b)
							}
							function A(b) {
								return a.enter("lineEnding"), a.consume(b), a.exit("lineEnding"), B
							}
							function B(b) {
								return null === b || aC(b) ? z(b) : (a.enter("htmlFlowData"), y(b))
							}
							function C(b) {
							...
							function E(b) {
								if (62 === b) {
									let c = f.toLowerCase()
									return bi.includes(c) ? (a.consume(b), H) : y(b)
								}
								return av(b) && f.length < 8 ? (a.consume(b), (f += String.fromCharCode(b)), E) : y(b)
							}
							function F(b) {
							...
							function H(b) {
								return null === b || aC(b) ? (a.exit("htmlFlowData"), I(b)) : (a.consume(b), H)
							}
							function I(c) {
					...
					60: [
						{
							...
							tokenize: function (a, b, c) {
								...
								function e(b) {
									return av(b) ? (a.consume(b), f) : 64 === b ? c(b) : h(b)
								}
								function f(b) {
									return 43 === b || 45 === b || 46 === b || aw(b)
										? ((d = 1),
											(function b(c) {
												return 58 === c
													? (a.consume(c), (d = 0), g)
													: (43 === c || 45 === c || 46 === c || aw(c)) && d++ < 32
														? (a.consume(c), b)
														: ((d = 0), h(c))
											})(b))
										: h(b)
								...
								function g(d) {
									return 62 === d
										? (a.exit("autolinkProtocol"),
											...
											a.exit("autolink"),
											b)
										: null === d || 32 === d || 60 === d || ay(d)
											? c(d)
											: (a.consume(d), g)
								}
								function h(b) {
									return 64 === b ? (a.consume(b), i) : ax(b) ? (a.consume(b), h) : c(b)
								}
								function i(e) {
									return aw(e)
										? (function e(f) {
						...
						},
						{
							...
							tokenize: function (a, b, c) {
								...
								function r(b) {
									return null === b || 62 === b ? D(b) : aC(b) ? ((f = r), E(b)) : (a.consume(b), r)
								}
								function s(b) {
									return null === b
										? c(b)
								...
								function u(b) {
									return av(b) ? (a.consume(b), v) : c(b)
								}
								function v(b) {
									return 45 === b || aw(b)
										? (a.consume(b), v)
										: (function b(c) {
												return aC(c) ? ((f = b), E(c)) : aE(c) ? (a.consume(c), b) : D(c)
											})(b)
								}
								function w(b) {
									return 45 === b || aw(b)
								...
								function y(b) {
									return 45 === b || 46 === b || 58 === b || 95 === b || aw(b)
										? (a.consume(b), y)
										: (function b(c) {
												return 61 === c
													? (a.consume(c), z)
					...
					92: [
						{
							...
							tokenize: function (a, b, c) {
								...
								function d(d) {
									return aC(d) ? (a.exit("hardBreakEscape"), b(d)) : c(d)
								}
							},
						},
						a2,
		...
		let bA = /\\([!-/:-@[-`{-~])|&(#(?:\d{1,7}|x[\da-f]{1,6})|[\da-z]{1,31});/gi
		function bB(a, b, c) {
			if (b) return b
			if (35 === c.charCodeAt(0)) {
				let a = c.charCodeAt(1),
					b = 120 === a || 88 === a
				return bz(c.slice(b ? 2 : 1), b ? 16 : 10)
			}
			return a5(c) || a
		}
		let bC = {}.hasOwnProperty
		function bD(a) {
			...
			if (a)
				throw Error(
					"Cannot close `" +
						a.type +
						"` (" +
						W({ start: a.start, end: a.end }) +
						"): a different token (`" +
						b.type +
						"`, " +
						W({ start: b.start, end: b.end }) +
						") is open",
				)
			throw Error(
					...
					(function (a) {
						let b = {
							...
							exit: {
								...
								characterReferenceValue: function (a) {
									...
									d
										? ((b = bz(c, "characterReferenceMarkerNumeric" === d ? 10 : 16)),
								...
								characterReference: function (a) {
									this.stack.pop().position.end = bD(a.end)
								},
								...
								definitionLabelString: function (a) {
									...
									;(c.label = b), (c.identifier = bf(this.sliceSerialize(a)).toLowerCase())
								},
								...
								labelText: function (a) {
									...
									;(c.label = b.replace(bA, bB)), (c.identifier = bf(b).toLowerCase())
								},
								lineEnding: function (a) {
									let c = this.stack[this.stack.length - 1]
									if (this.data.atHardBreak) {
										;(c.children[c.children.length - 1].position.end = bD(a.end)),
								...
								referenceString: function (a) {
									let b = this.resume(),
										c = this.stack[this.stack.length - 1]
									;(c.label = b),
										(c.identifier = bf(this.sliceSerialize(a)).toLowerCase()),
						...
						return function (a) {
							...
							if (g.tokenStack.length > 0) {
								...
								;(a[1] || bE).call(g, void 0, a[0])
							}
							for (
								d.position = {
									start: bD(a.length > 0 ? a[0][1].start : { line: 1, column: 1, offset: 0 }),
									end: bD(a.length > 0 ? a[a.length - 2][1].end : { line: 1, column: 1, offset: 0 }),
								},
									k = -1;
						...
						function f(a, b, c) {
							this.stack[this.stack.length - 1].children.push(a),
								...
								(a.position = { start: bD(b.start), end: void 0 })
						}
						function g(a) {
							return function (b) {
						...
						function h(a, b) {
							...
							if (d)
								d[0].type !== a.type && (b ? b.call(this, a, d[0]) : (d[1] || bE).call(this, a, d[0]))
							else
								throw Error(
									"Cannot close `" +
										a.type +
						...
						function j(a) {
							let b = this.stack[this.stack.length - 1].children,
								c = b[b.length - 1]
							;(c && "text" === c.type) ||
								(((c = { type: "text", value: "" }).position = { start: bD(a.start), end: void 0 }),
								b.push(c)),
								this.stack.push(c)
						}
						function k(a) {
							let b = this.stack.pop()
							;(b.value += this.sliceSerialize(a)), (b.position.end = bD(a.end))
						}
						function l() {
											...
											let d = {
												...
												j = {
													...
													write: function (a) {
														...
														null !== g[g.length - 1])
															? []
															: (p(b, 0), (j.events = a$(f, j.events, j)), j.events)
													},
												},
								...
								.write(
									...
									function (a, b, c) {
										...
										for (
											...
											if (
												((by.lastIndex = j),
												(k = (d = by.exec(a)) && void 0 !== d.index ? d.index : a.length),
												(l = a.charCodeAt(k)),
												!d)
											) {
												h = a.slice(j)
		...
		let bG = "object" == typeof self ? self : globalThis,
			bH = (a) => {
				var b
				let c, d
				return ((b = new Map()),
					...
					(h = (a) => {
						...
						switch (b) {
							...
							case 2: {
								...
								let f = [],
									i = g([b, f], a)
								for (let b of bJ(a)) (d || !bL(bK(a[b]))) && f.push([h(b), h(a[b])])
								return i
							}
							case 3:
							...
							case 5: {
								let c = [],
									e = g([b, c], a)
								for (let [b, e] of a) (d || !(bL(bK(b)) || bL(bK(e)))) && c.push([h(b), h(e)])
								return e
							}
							case 6: {
								let c = [],
			...
			bN =
				"function" == typeof structuredClone
					? (a, b) => (b && ("json" in b || "lossy" in b) ? bH(bM(a, b)) : structuredClone(a))
					: (a, b) => bH(bM(a, b))
		function bO(a) {
			let b = [],
				c = -1,
			...
			for (; ++c < a.length; ) {
				let f = a.charCodeAt(c),
					g = ""
				if (37 === f && aw(a.charCodeAt(c + 1)) && aw(a.charCodeAt(c + 2))) e = 2
			...
			table: function (a, b) {
				...
				if (c.length > 0) {
					let d = { type: "element", tagName: "tbody", properties: {}, children: a.wrap(c, !0) },
						f = U(b.children[1]),
						g = T(b.children[b.children.length - 1])
		...
		function b6(a, b) {
			let c,
								...
								for (; ++d < c.length; ) {
									...
									if (e) {
										if (
											d &&
											"break" === c[d - 1].type &&
											(Array.isArray(e) || "text" !== e.type || (e.value = b5(e.value)),
						...
						one: function (a, b) {
							...
							return (
								...
								function (a, b) {
									let c = b.data || {},
										d =
											"value" in b && !(b0.call(c, "hProperties") || b0.call(c, "hChildren"))
				...
				k = Array.isArray(i) ? { type: "root", children: i } : i || { type: "root", children: [] }
			return j && (d("children" in k), k.children.push({ type: "text", value: "\n" }, j)), k
		}
		function b7(a, b) {
			return a && "run" in a
				? async function (c, d) {
		...
		class cg {
				...
				;(b = a
					? ce(a)
						...
						: "string" == typeof a ||
							...
							: a
					: {}),
					(this.cwd = "cwd" in b ? "" : cc.minproc.cwd()),
					(this.data = {}),
					(this.history = []),
					(this.messages = []),
					this.value,
			...
			get basename() {
				return "string" == typeof this.path ? cb.minpath.basename(this.path) : void 0
			}
			set basename(a) {
				ci(a, "basename"), ch(a, "basename"), (this.path = cb.minpath.join(this.dirname || "", a))
			}
			get dirname() {
				return "string" == typeof this.path ? cb.minpath.dirname(this.path) : void 0
			}
			set dirname(a) {
				cj(this.basename, "dirname"), (this.path = cb.minpath.join(a || "", this.basename))
			}
			get extname() {
				return "string" == typeof this.path ? cb.minpath.extname(this.path) : void 0
			}
			set extname(a) {
				...
				this.path = cb.minpath.join(this.dirname, this.stem + (a || ""))
			}
			get path() {
				return this.history[this.history.length - 1]
			}
			set path(a) {
				ce(a) && (a = (0, cd.urlToPath)(a)), ci(a, "path"), this.path !== a && this.history.push(a)
			}
			get stem() {
				return "string" == typeof this.path ? cb.minpath.basename(this.path, this.extname) : void 0
			}
			set stem(a) {
				ci(a, "stem"),
					ch(a, "stem"),
					(this.path = cb.minpath.join(this.dirname || "", a + (this.extname || "")))
			}
			fail(a, b, c) {
		...
		function ch(a, b) {
			if (a && a.includes(cb.minpath.sep))
				throw Error("`" + b + "` cannot be a path: did not expect `" + cb.minpath.sep + "`")
		}
		function ci(a, b) {
		...
		class cm extends ck {
			...
			process(a, b) {
				...
				function e(e, f) {
					let g = ct(a),
						h = c.parse(g)
					function i(a, c) {
						a || !c ? f(a) : e ? e(c) : (d(b, "`done` is defined if `resolve` is not"), b(void 0, c))
					}
					c.run(h, g, function (a, b, d) {
						var e, f
						if (a || !b || !d) return i(a)
			...
			processSync(a) {
				...
				return (
					...
					cs("processSync", "process", c),
					d(b, "we either bailed on an error or have a tree"),
					b
				)
			}
			run(a, b, c) {
				...
				return c || "function" != typeof b || ((c = b), (b = void 0)), c ? f(void 0, c) : new Promise(f)
				function f(f, g) {
					d("function" != typeof b, "`file` can’t be a `done` anymore, we checked")
					let h = ct(b)
					e.run(a, h, function (b, e, h) {
						let i = e || a
						b ? g(b) : f ? f(i) : (d(c, "`done` is defined if `resolve` is not"), c(void 0, i, h))
					})
				}
			}
			runSync(a, b) {
				...
				return (
					...
					cs("runSync", "run", e),
					d(c, "we either bailed on an error or have a tree"),
					c
				)
			}
			stringify(a, b) {
			...
			use(a, ...b) {
				...
				function e(a) {
					...
					f(a.plugins), a.settings && (d.settings = (0, b9.default)(!0, d.settings, a.settings))
				}
				function f(a) {
					let b = -1
					if (null == a);
				...
				function g(a, b) {
					...
					if (-1 === e) c.push([a, ...b])
						...
						let [d, ...f] = b,
							g = c[e][1]
						ca(g) && ca(d) && (d = (0, b9.default)(!0, g, d)), (c[e] = [a, d, ...f])
					}
				}
			}
		}
		...
		function cr(a) {
			if (!ca(a) || "string" != typeof a.type) throw TypeError("Expected node, got `" + a + "`")
		}
		function cs(a, b, c) {
		...
		function ct(a) {
			var b
			return (b = a) && "object" == typeof b && "message" in b && "messages" in b ? a : new cg(a)
		}
		let cu = [],
		...
		function cy(a) {
			...
			let d,
				...
				i,
				j =
					((d = (c = a).rehypePlugins || cu),
					(f = c.remarkPlugins || cu),
					(g = c.remarkRehypeOptions ? { ...c.remarkRehypeOptions, ...cv } : cv),
					cn().use(bF).use(f).use(b7, g).use(d)),
				k =
					((h = a.children || ""),
					(i = new cg()),
					"string" == typeof h
						? (i.value = h)
						: e("Unexpected value `" + h + "` for `children` prop, expected `string`"),
					i)
			return (function (a, c) {
				...
				return (
					d &&
						h &&
						e("Unexpected combined `allowedElements` and `disallowedElements`, expected one or the other"),
					c.className &&
						(a = {
							type: "element",
							tagName: "div",
					...
					bW(a, function (a, b, c) {
						if ("raw" === a.type && c && "number" == typeof b)
							return i ? c.children.splice(b, 1) : (c.children[b] = { type: "text", value: a.value }), b
						if ("element" === a.type) {
							let b
							for (b in am)
								if (Object.hasOwn(am, b) && Object.hasOwn(a.properties, b)) {
						...
						if ("element" === a.type) {
							let e = d ? !d.includes(a.tagName) : !!h && h.includes(a.tagName)
							if ((!e && f && "number" == typeof b && (e = !f(a, b, c)), e && c && "number" == typeof b))
								return (
									j && a.children ? c.children.splice(b, 1, ...a.children) : c.children.splice(b, 1),
									b
								)
						}
					}),
		...
		function cG(a) {
			...
			let b = this.stack[this.stack.length - 1]
			d("link" === b.type), (b.url = "http://" + this.sliceSerialize(a))
		}
		function cH(a) {
		...
		function cM(a, b) {
			...
			return (0 === a.index || aG(c) || aF(c)) && (!b || 47 !== c)
		}
		function cN() {
			this.buffer()
		}
		...
		function cR(a) {
			let b = this.resume(),
				c = this.stack[this.stack.length - 1]
			d("footnoteReference" === c.type), (c.identifier = bf(this.sliceSerialize(a)).toLowerCase()), (c.label = b)
		}
		function cS(a) {
			this.exit(a)
		}
		function cT(a) {
			let b = this.resume(),
				c = this.stack[this.stack.length - 1]
			d("footnoteDefinition" === c.type), (c.identifier = bf(this.sliceSerialize(a)).toLowerCase()), (c.label = b)
		}
		function cU(a) {
			this.exit(a)
		}
		...
		let cY = ["autolink", "destinationLiteral", "destinationRaw", "reference", "titleQuote", "titleApostrophe"]
		function cZ(a) {
		...
		function c9(a) {
			...
			let c = this.stack[this.stack.length - 1]
			d("inlineCode" === c.type), (c.value = b), this.exit(a)
		}
		function da(a, b) {
			return "|" === b ? b : a
		}
		function db(a) {
			...
			d("listItem" === b.type), (b.checked = "taskListCheckValueChecked" === a.type)
		}
		function dc(a) {
			let b = this.stack[this.stack.length - 2]
		...
		let de = {
					...
					function d(g) {
						return 33 === g ||
							...
							: 38 === g
								...
								: 93 === g
									? (a.consume(g), e)
									: 60 === g || null === g || aD(g) || aG(g)
										? b(g)
										: c(g)
					}
					function e(a) {
						return null === a || 40 === a || 91 === a || aD(a) || aG(a) ? b(a) : d(a)
					}
					function f(b) {
						return av(b)
							? (function b(e) {
									return 59 === e ? (a.consume(e), d) : av(e) ? (a.consume(e), b) : c(e)
								})(b)
							: c(b)
					}
				},
			...
			dj = {
				...
				tokenize: function (a, b, c) {
					let d = this
					return function (b) {
						return (87 !== b && 119 !== b) || !dp.call(d, d.previous) || dt(d.events)
							? c(b)
			...
			dk = {
				...
				tokenize: function (a, b, c) {
					let d = this,
						...
						f = !1
					return function (b) {
						return (72 === b || 104 === b) && dq.call(d, d.previous) && !dt(d.events)
							? (a.enter("literalAutolink"),
					...
					function g(b) {
						if (av(b) && e.length < 5) return (e += String.fromCodePoint(b)), a.consume(b), g
						if (58 === b) {
							let c = e.toLowerCase()
					...
					function i(b) {
						return null === b || ay(b) || aD(b) || aG(b) || aF(b)
							? c(b)
					...
					return function (b) {
						return !ds(b) || !dr.call(f, f.previous) || dt(f.events)
							...
							: (a.enter("literalAutolink"),
								...
								(function b(d) {
									return ds(d) ? (a.consume(d), b) : 64 === d ? (a.consume(d), g) : c(d)
								})(b))
					}
					function g(b) {
						return 46 === b
			...
			dm = {},
			dn = 48
		for (; dn < 123; ) (dm[dn] = dl), 58 == ++dn ? (dn = 65) : 91 === dn && (dn = 97)
		function dp(a) {
			return null === a || 40 === a || 42 === a || 95 === a || 91 === a || 93 === a || 126 === a || aD(a)
		}
		function dq(a) {
			return !av(a)
		}
		...
		function ds(a) {
			return 43 === a || 45 === a || 46 === a || 95 === a || aw(a)
		}
		function dt(a) {
			let b = a.length,
				c = !1
		...
		function dv(a, b, c) {
			...
			return function (f) {
				...
				let h = bf(e.sliceSerialize({ start: d.end, end: e.now() }))
		...
		function dx(a, b, c) {
			...
			function i(h) {
				if (g > 999 || (93 === h && !d) || null === h || 91 === h || aD(h)) return c(h)
				if (93 === h) {
					a.exit("chunkString")
					let d = a.exit("gfmFootnoteCallString")
					return f.includes(bf(e.sliceSerialize(d)))
						? (a.enter("gfmFootnoteCallLabelMarker"),
							a.consume(h),
							a.exit("gfmFootnoteCallLabelMarker"),
				...
				return aD(h) || (d = !0), g++, a.consume(h), 92 === h ? j : i
			}
			function j(b) {
		...
		function dy(a, b, c) {
			...
			function j(b) {
				if (h > 999 || (93 === b && !e) || null === b || 91 === b || aD(b)) return c(b)
				if (93 === b) {
					a.exit("chunkString")
					let c = a.exit("gfmFootnoteDefinitionLabelString")
					return (
						(d = bf(f.sliceSerialize(c))),
						a.enter("gfmFootnoteDefinitionLabelMarker"),
						a.consume(b),
						a.exit("gfmFootnoteDefinitionLabelMarker"),
				...
				return aD(b) || (e = !0), h++, a.consume(b), 92 === b ? k : j
			}
			function k(b) {
			...
			function l(b) {
				return 58 === b
					? (a.enter("definitionMarker"),
						...
						aI(a, m, "gfmFootnoteDefinitionWhitespace"))
					: c(b)
			}
			function m(a) {
				return b(a)
		...
		function dz(a, b, c) {
			return a.check(aM, b, a.attempt(du, b, c))
		}
		function dA(a) {
		...
		function dC(a, b, c) {
			...
			function j(b) {
				return null === b || 124 === b || aD(b) ? (a.exit("data"), i(b)) : (a.consume(b), 92 === b ? k : j)
			}
			function k(b) {
			...
			function l(b) {
				return ((e.interrupt = !1), e.parser.lazy[e.now().line])
					? c(b)
					: (a.enter("tableDelimiterRow"), (d = !1), aE(b))
						? aI(
								a,
								m,
								"linePrefix",
			...
			function n(b) {
				return aE(b) ? aI(a, o, "whitespace")(b) : o(b)
			}
			function o(b) {
				return 58 === b
					? ((g += 1),
			...
			function q(b) {
				return aE(b) ? aI(a, r, "whitespace")(b) : r(b)
			}
			function r(e) {
				if (124 === e) return m(e)
				if (null === e || aC(e))
			...
			function u(b) {
				return null === b || 124 === b || aD(b) ? (a.exit("data"), t(b)) : (a.consume(b), 92 === b ? v : u)
			}
			function v(b) {
		...
		function dD(a, b) {
						...
						: "tableRow" === o.type || "tableDelimiterRow" === o.type
							...
							: h &&
								...
								? ((g = !1),
									0 === j[2] &&
										(0 !== i[1] &&
											((j[0] = j[1]), (e = dE(m, b, i, h, void 0, e)), (i = [0, 0, 0, 0])),
										(j[2] = f)))
								: "tableCellDivider" === o.type &&
									(g
										? (g = !1)
										: (0 !== i[1] && ((j[0] = j[1]), (e = dE(m, b, i, h, void 0, e))),
											(j = [(i = j)[1], f, 0, 0])))
					: "tableHead" === o.type
						? ((k = !0), (l = f))
						: "tableRow" === o.type || "tableDelimiterRow" === o.type
			...
			for (0 !== l && dF(m, b, l, c, d), m.consume(b.events), f = -1; ++f < b.events.length; ) {
				let a = b.events[f]
				"enter" === a[0] &&
					"table" === a[1].type &&
		...
		function dE(a, b, c, d, e, f) {
			0 !== c[0] && ((f.end = Object.assign({}, dG(b.events, c[0]))), a.add(c[0], 0, [["exit", f, b]]))
			...
			return (
				void 0 !== e &&
					((f.end = Object.assign({}, dG(b.events, e))), a.add(e, 0, [["exit", f, b]]), (f = void 0)),
				f
			)
		}
		...
		let dH = {
			...
			tokenize: function (a, b, c) {
				...
				function g(d) {
					return aC(d) ? b(d) : aE(d) ? a.check({ tokenize: dI }, b, c)(d) : c(d)
				}
			},
		}
		function dI(a, b, c) {
		...
		function dK(a) {
			...
			g.push(
				au([
					{ text: dm },
					{
						...
						text: {
							...
							93: { name: "gfmPotentialFootnoteCall", add: "after", tokenize: dv, resolveTo: dw },
						},
					},
					((b = (e || {}).singleTilde),
					(c = {
								...
								if (
									...
									for (; d--; )
										if (
											...
											h && ar(g, g.length, 0, a$(h, a.slice(d + 1, c), b)),
												ar(g, g.length, 0, [
													["exit", f, b],
													["enter", a[c][1], b],
													["exit", a[c][1], b],
				...
				h.push([
					...
					{ canContainEols: ["delete"], enter: { strikethrough: cZ }, exit: { strikethrough: c$ } },
					{
						enter: { table: c4, tableData: c8, tableHeader: c8, tableRow: c6 },
						exit: { codeText: c9, table: c5, tableData: c7, tableHeader: c7, tableRow: c7 },
					},
					{ exit: { taskListCheckValueChecked: db, taskListCheckValueUnchecked: db, paragraph: dc } },
				]),
				i.push({
					extensions: [
						{
							unsafe: [
								...
								{ character: ":", before: "[ps]", after: "\\/", inConstruct: cB, notInConstruct: cC },
							],
						},
						((d = !1),
								...
								footnoteDefinition: function (a, b, c, e) {
									...
									return (
										...
										a.children &&
											...
											(g += f.move(
												(d ? "\n" : " ") +
													c.indentLines(c.containerFlow(a, f.current()), d ? cX : cW),
											))),
										h(),
										g
									)
						...
						{
							unsafe: [{ character: "~", inConstruct: "phrasing", notInConstruct: cY }],
							handlers: { delete: c_ },
						},
						(function (a) {
							let b = a || {},
							...
							function h(a, b) {
								return (function (a, b) {
									...
									let m = -1
									if ("object" == typeof d && "length" in d) for (; ++m < j; ) f[m] = c1(d[m])
									else {
										let a = c1(d)
										for (; ++m < j; ) f[m] = a
									}
						...
						{ unsafe: [{ atBreak: !0, character: "-", after: "[:|-]" }], handlers: { listItem: dd } },
					],
				})
		}
		let dL = (0, a.i(8402).default)("play", [
			[
				"path",
				{
		...
		var dM = a.i(49939)
		let dN = /(?:youtube\.com\/(?:[^/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/)([^"&?/\s]{11})/i,
			dO = /(?:[?&#](?:t|start)=)([0-9hms:]+)/i
		function dP({ open: a, onOpenChange: d, videoId: e, startTime: f = 0, title: g }) {
			let h = c.useMemo(() => {
				let a = new URLSearchParams({ autoplay: "1", rel: "0", modestbranding: "1" })
				return f > 0 && a.set("start", f.toString()), `https://www.youtube.com/embed/${e}?${a.toString()}`
			}, [e, f])
			return (0, b.jsx)(dM.Dialog, {
				open: a,
				onOpenChange: d,
				children: (0, b.jsxs)(dM.DialogContent, {
					className: "max-w-4xl w-[90vw] p-0 overflow-hidden bg-black",
					"aria-describedby": void 0,
					children: [
						(0, b.jsx)(dM.DialogTitle, { className: "sr-only", children: g ?? "YouTube Video" }),
						(0, b.jsx)("div", {
		...
		function dQ({ content: a }) {
			let [d, e] = c.useState({ isOpen: !1, videoId: "", startTime: 0, title: "" }),
				f = c.useCallback((a, b) => {
					let c,
						d,
						f = ((c = a.match(dN)), c?.[1] ?? null)
					f &&
						e({
							isOpen: !0,
							videoId: f,
							startTime:
								...
								d?.[1]
									? (function (a) {
											...
											let b = a.match(/^(\d{1,2}):(\d{2})(?::(\d{2}))?$/)
											if (b) {
												let a = parseInt(b[1] ?? "0", 10),
													c = parseInt(b[2] ?? "0", 10),
													d = b[3] ? parseInt(b[3], 10) : null
												return null === d ? 60 * a + c : 3600 * a + 60 * c + d
											}
											let c = 0,
												d = a.match(/(\d+)h/i),
												e = a.match(/(\d+)m/i),
												f = a.match(/(\d+)s/i)
											return (
												d?.[1] && (c += 3600 * parseInt(d[1], 10)),
												e?.[1] && (c += 60 * parseInt(e[1], 10)),
												f?.[1] && (c += parseInt(f[1], 10)),
												c
											)
										})(d[1])
									: 0),
			...
			return (0, b.jsxs)(b.Fragment, {
				children: [
					(0, b.jsx)(cy, {
						...
						components: {
							h1: ({ node: a, ...c }) =>
								(0, b.jsx)("h2", { className: "mt-12 text-2xl font-bold", ...c }),
							h2: ({ node: a, ...c }) =>
								(0, b.jsx)("h2", { className: "mt-12 text-2xl font-bold", ...c }),
							h3: ({ node: a, ...c }) =>
								(0, b.jsx)("h3", { className: "mt-8 text-xl font-semibold", ...c }),
							a: ({ href: a, children: c, node: d }) => {
								let e = a ?? "",
									g = "string" == typeof c ? c : Array.isArray(c) ? c.join("") : "YouTube Video"
								return dN.test(e)
									? (0, b.jsxs)("button", {
											type: "button",
											onClick: (a) => {
												a.preventDefault(), f(e, g)
											},
											className: "inline-flex items-baseline gap-1 text-primary hover:underline",
											children: [(0, b.jsx)(dL, { className: "relative top-px h-4 w-4" }), c],
										})
									: (0, b.jsx)("a", {
							...
							blockquote: ({ node: a, ...c }) => {
								let d = a?.children,
									e = (function a(b) {
										...
										let c = (function (a) {
											if ("link" === a.type && "string" == typeof a.url) return a.url
											if ("element" === a.type && "a" === a.tagName) {
												let b = a.properties
												if ("string" == typeof b?.href) return b.href
											}
											return null
										})(b)
										if (c && dN.test(c)) return !0
										let d = b.children
										return !!Array.isArray(d) && d.some(a)
									})(
										Array.isArray(d)
											? [...d]
													.reverse()
													.find(
														(a) =>
															!!a &&
															"object" == typeof a &&
															("paragraph" === a.type || "element" === a.type),
													)
											: null,
									)
								return (0, b.jsx)("blockquote", {
									className: [
										"not-prose my-6 border-l-4 border-primary pl-4 text-muted-foreground [&>p]:m-0 [&>p+ p]:mt-4",
										e ? "[&>p:not(:last-child)]:italic [&>p:last-child]:not-italic" : "italic",
									].join(" "),
									...c,
								})
							},
							code: ({ className: a, children: c, node: d, ...e }) =>
								a
									? (0, b.jsx)("code", { className: a, ...e, children: c })
									: (0, b.jsx)("code", {
											className: "rounded bg-muted px-1.5 py-0.5 text-sm",
											...e,
											children: c,
										}),
							strong: ({ node: a, ...c }) => (0, b.jsx)("strong", { className: "font-semibold", ...c }),
							p: ({ node: a, ...c }) =>
								(0, b.jsx)("p", { className: "leading-7 [&:not(:first-child)]:mt-6", ...c }),
							ul: ({ node: a, ...c }) =>
								(0, b.jsx)("ul", { className: "my-6 ml-6 list-disc [&>li]:mt-2", ...c }),
							ol: ({ node: a, ...c }) =>
								(0, b.jsx)("ol", { className: "my-6 ml-6 list-decimal [&>li]:mt-2", ...c }),
							table: ({ node: a, ...c }) =>
								(0, b.jsx)("div", {
							...
							thead: ({ node: a, ...c }) => (0, b.jsx)("thead", { className: "bg-muted", ...c }),
							tbody: ({ node: a, ...c }) => (0, b.jsx)("tbody", { ...c }),
							tr: ({ node: a, ...c }) =>
								(0, b.jsx)("tr", {
									className:
							...
							td: ({ node: a, ...c }) => (0, b.jsx)("td", { className: "px-4 py-3", ...c }),
						},
						children: a,
					}),
					(0, b.jsx)(dP, {
		...
		a.s(["BlogContent", () => dQ, "default", 0, dQ], 77300)
	},
	11350,
	(a) => {
		"use strict"
										...
										"div",
										{
											...
											children: [
												...
												(0, b.jsxs)("div", {
													...
													"aria-hidden": "true",
													children: [
														(0, b.jsx)("p", { children: a.question }),
														(0, b.jsx)("p", { children: a.answer }),
													],
												}),
											],
										},
...
//# sourceMappingURL=_df798a3b._.js.map

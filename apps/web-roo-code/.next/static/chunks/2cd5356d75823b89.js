;(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, r) => {
		...
		let n = e.r(47282).createRenderSearchParamsFromClient
		;("function" == typeof r.default || ("object" == typeof r.default && null !== r.default)) &&
			void 0 === r.default.__esModule &&
			(Object.defineProperty(r.default, "__esModule", { value: !0 }),
			Object.assign(r.default, r),
	...
	(e, t, r) => {
		...
		let n = e.r(47362).createRenderParamsFromClient
		;("function" == typeof r.default || ("object" == typeof r.default && null !== r.default)) &&
			void 0 === r.default.__esModule &&
			(Object.defineProperty(r.default, "__esModule", { value: !0 }),
			Object.assign(r.default, r),
	...
	(e, t, r) => {
		...
		class u {
			...
			abandonRender() {
				if (!this.mayAbandon)
					throw Object.defineProperty(
						new i.InvariantError("`abandonRender` called on a stage controller that cannot be abandoned."),
						"__NEXT_ERROR_CODE",
		...
		function h(e, t) {
			...
			if (r)
				switch (r.type) {
					...
					case "unstable-cache":
						throw Object.defineProperty(
							new u.InvariantError("createParamsFromClient should not be called in cache contexts."),
							"__NEXT_ERROR_CODE",
							{ value: "E736", enumerable: !1, configurable: !0 },
						)
					case "prerender-runtime":
						throw Object.defineProperty(
							new u.InvariantError("createParamsFromClient should not be called in a runtime prerender."),
							"__NEXT_ERROR_CODE",
		...
		function g(e, t) {
			...
			if (r)
				switch (r.type) {
					...
					case "unstable-cache":
						throw Object.defineProperty(
							new u.InvariantError("createServerParamsForRoute should not be called in cache contexts."),
							"__NEXT_ERROR_CODE",
	...
	(e, t, r) => {
		...
		function u({ Component: t, serverProvidedParams: r }) {
			...
			if ("u" < typeof window) {
				...
				let { createSearchParamsFromClient: c } = e.r(14837)
				r = c(u, s)
				let { createParamsFromClient: d } = e.r(38153)
				return (o = d(l, s)), (0, n.jsx)(t, { params: o, searchParams: r })
			}
			{
				let { createRenderSearchParamsFromClient: r } = e.r(74678),
					a = r(u),
					{ createRenderParamsFromClient: o } = e.r(5821),
					i = o(l)
	...
	(e, t, r) => {
		...
		function s({ Component: t, slots: r, serverProvidedParams: s }) {
			...
			if ("u" < typeof window) {
				...
				let { createParamsFromClient: u } = e.r(38153)
				return (o = u(c, s)), (0, n.jsx)(t, { ...r, params: o })
			}
			{
				let { createRenderParamsFromClient: a } = e.r(5821),
					o = a(c)

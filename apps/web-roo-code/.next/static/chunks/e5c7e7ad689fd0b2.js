;(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, r) => {
		...
		function L(e, t) {
			...
			return (
				n ||
					((n = e._closed ? new m("rejected", null, e._closedReason) : new m("pending", null, null)),
					r.set(t, n)),
				n
			)
		}
		...
		function B(e, t, r, n, a, l) {
			return (
				U
					? ((n = U), n.deps++)
					: (n = U = { parent: null, chunk: null, value: null, reason: null, deps: 1, errored: !1 }),
			...
			switch (l.status) {
				...
				case "halted":
					return (
						U
							? ((e = U), e.deps++)
							: (U = { parent: null, chunk: null, value: null, reason: null, deps: 1, errored: !1 }),
						null
					)
				default:
					return (
						U
							? ((U.errored = !0), (U.value = null), (U.reason = l.reason))
							: (U = { parent: null, chunk: null, value: null, reason: l.reason, deps: 0, errored: !0 }),
						null
					)
			}
		}
		...
		function er(e, t, r) {
			...
			;(u[g] = function () {
				...
				Z(e, t, r ? u[g]() : u, {
					...
					close: function (t) {
						if (!a)
							for (a = !0, l === n.length ? (n[l] = A(e, t, !0)) : M(e, n[l], t, !0), l++; l < n.length; )
								M(e, n[l++], '"$undefined"', !0)
					},
					error: function (t) {
						if (!a)
											...
											switch (((l = o += t.decode(u)), n)) {
												case 73:
													...
													if ((p = c(g))) {
														...
														y
															? C(s, y, g)
															: ((y = new m("resolved_module", g, null)), h.set(f, y))
													break
												case 72:
													switch (
														((r = l[0]),
												...
												case 69:
													;(u = (n = e._chunks).get(r)),
														...
														u ? w(e, u, t) : ((e = new m("rejected", null, t)), n.set(r, e))
													break
												case 84:
	...
	(e, t, r) => {
		...
		async function R(e, t) {
			...
			try {
				...
				return (
					v || console.error(`Failed to fetch RSC payload for ${e}. Falling back to browser navigation.`, t),
					e.toString()
				)
			}
		}
		async function b(e, t, r, a, l) {
			...
			let y = fetch(p, { credentials: "same-origin", headers: t, priority: r || void 0, signal: l }),
				_ = a
					? ((u = y),
						(c = t),
						g(u, {
		...
		function E(e, t) {
			return y(e, { callServer: i.callServer, findSourceMapURL: s.findSourceMapURL, debugChannel: n && n(t) })
		}
		"u" > typeof window &&
	...
	(e, t, r) => {
		...
		function R(e, t, r, n, a, l, c, f, d, h, y, g, _) {
			return (function e(t, r, n, a, l, c, f, d, h, y, g, _, v, R, T, j, w, A) {
				var M, N
				let C,
					U,
					F,
		...
		function b(e, t, r, n, a, l, u, o, i, c, f, d, p) {
			...
			if (
				(F && (null === p.scrollableSegments && (p.scrollableSegments = []), p.scrollableSegments.push(v)),
				M || void 0 === r)
			)
				if (null !== a && null !== a[0]) {
					let t = a[0],
			...
			for (let t in R) {
				let r = R[t],
					...
					y = b(e, r, void 0 !== a ? a.get(h) : void 0, n, u ?? null, l, c ?? null, o, i, v, t, d || g, p)
		...
		function S(e, t, r, n, a, l, u, o) {
			...
			return (
				...
				{ rsc: i, prefetchRsc: s, head: f, prefetchHead: c, loading: t, parallelRoutes: u, navigatedAt: o }
			)
		}
		function O(e, t, r, n) {
			let a = 1 === n
		...
		async function M(e, t, r, n, a) {
			try {
				let l = await (0, c.fetchServerResponse)(r, { flightRouterState: t, nextUrl: n, isHmrRefresh: 4 === a })
		...
		async function Y(e, t, r) {
			...
			try {
				...
				let S = (0, d.createHrefFromUrl)(p),
					...
					w = (0, m.createPromiseWithResolvers)(),
					A = "2" === r.headers.get(o.NEXT_DID_POSTPONE_HEADER)
				if (A) {
					let t,
						n,
						a = en(r.body, w.resolve, function (t) {
	...
	(e, t, r) => {
		...
		let n = (0, e.r(80588).createAsyncLocalStorage)()
	},
	53880,
	(e, t, r) => {
		"use strict"
	...
	(e, t, r) => {
		...
		let l = e.r(17724),
			u = e.r(49183),
			o = "u" < typeof window ? e.r(53880).actionAsyncStorage : void 0
	...
	(e, t, r) => {
		...
		async function T(e, t, { actionId: r, actionArgs: c }) {
			...
			let w = await fetch(e.canonicalUrl, { method: "POST", headers: T, body: S })
				...
				async ({
					...
					if (((e.pushRef.pendingPush = v), (a.pendingPush = v), void 0 !== p)) {
						...
						if ((0, P.isExternalURL)(p)) {
							let r = p.href
							return n(w(r, t)), (0, f.handleExternalUrl)(e, a, r, v)
						}
						{
							let e = (0, c.createHrefFromUrl)(p, !1)
							n(w((0, _.hasBasePath)(e) ? (0, g.removeBasePath)(e) : e, t))
						}
					} else r(o)
					...
					return (0, f.handleNavigationResult)(O, e, a, v, A)
				},
				(t) => (n(t), e),
			)
		}

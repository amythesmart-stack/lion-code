	...
	implements vscode.WebviewViewProvider, TelemetryPropertiesProvider, TaskProviderLike
{
	...
	public readonly latestAnnouncementId = "may-2026-v3.54.0-zoo-community-handoff-gpt55-opus47" // v3.54.0 Zoo Code release messaging, GPT-5.5, Claude Opus 4.7, checkpoint navigation
